                ...
                React.createElement("div", {id: "metadata"}, 
                    ...
                    React.createElement("div", {className: "metadata-view"}, 
                        ...
                        React.createElement("div", {className: "metadata-ocid"}, 
                            ...
                            React.createElement("span", null, disclosureMode || "-")
                        ), 
                        annexes_missing, 
                        pages_missing, 
...
var ClipAll = React.createClass({displayName: "ClipAll",
    componentDidMount: function () {
        var self = this;
        this.props.annotationsCollection.on("reset", function () {
            self.forceUpdate();
...
var AnnotationsList = React.createClass({displayName: "AnnotationsList",
    ...
    render: function () {
        if (this.props.annotationsCollection.models.length > 0) {
            ...
            return (
                React.createElement("div", {className: "annotations-list", id: "id-annotations-list"}, 
                    React.createElement("p", {className: "annotation-loading"}, this.state.message)
                )
            );
        }
    }
    ...
    render: function () {
        ...
        if (!this.props.annotations_url && !this.props.text_url) {
            ...
            return (
                React.createElement("div", {className: "right-column-view"}, 
                    React.createElement("div", {className: "download-dropdown"}, 
                        ...
                        React.createElement("ul", {className: "dropdown-menu", style: style}, 
                            React.createElement("li", null, React.createElement("a", {href: this.props.pdf_url}, lang.pdf)), 
                            React.createElement("li", null, React.createElement("a", {href: this.props.annotations_url}, 
                                React.createElement("div", {dangerouslySetInnerHTML: {__html: lang.annotations_excel}})
                            ))
                        )
                    ), 
            ...
            return (
                React.createElement("div", {className: "right-column-view"}, 
                    React.createElement("div", {className: "download-dropdown"}, 
                        React.createElement("a", {onClick: this.toggleDropdown}, React.createElement("span", null, lang.download)), 
                        React.createElement("ul", {className: "dropdown-menu", style: style}, 
                            React.createElement("li", null, React.createElement("a", {href: this.props.pdf_url}, lang.pdf)), 
                            React.createElement("li", null, React.createElement("a", {href: this.props.text_url}, lang.word_file)), 
                            React.createElement("li", null, React.createElement("a", {href: this.props.annotations_url}, 
                    ...
                    React.createElement("div", {className: "modal-content"}, 
                        React.createElement("div", {className: "modal-header"}, 
                            React.createElement("button", {type: "button", className: "close", "data-dismiss": "modal", "aria-label": "Close"}, React.createElement("span", {
                                "aria-hidden": "true"}, "×")), 
                            React.createElement("h4", {className: "modal-title"}, "Share via email")
                        ), 
                        React.createElement("div", {className: "modal-body"}, 
                            React.createElement("div", {className: "email-result"}), 
                            React.createElement("form", {onSubmit: this.handleSubmit}, 
                                React.createElement("div", {className: "form-group"}, 
                                    React.createElement("label", {for: "emailto"}, "To"), 
                                    React.createElement("input", {type: "text", onChange: function(e) {self.setState({to:e.target.value})}, 
                                           value: this.state.to, className: "form-control"}), 
                                    this.getError('to')
                                ), 
                                React.createElement("div", {className: "form-group"}, 
                                    React.createElement("label", {for: "emailfrom"}, "From"), 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    ...
                                    React.createElement("input", {type: "text", onChange: function(e) {self.setState({subject:e.target.value})}, 
                                           value: this.state.subject, className: "form-control"}), 
                                    this.getError('subject')
                                ), 
                                React.createElement("div", {className: "form-group"}, 
                                    React.createElement("label", {for: "emailbody"}, "Message"), 
                                    React.createElement("textarea", {type: "text", onChange: function(e) {self.setState({body:e.target.value})}, 
...
var ClipCount = React.createClass({displayName: "ClipCount",

    render: function () {
        return (
            React.createElement("div", null, 

                React.createElement("a", {href: clipUrl, id: "annotation-count"}), 
                React.createElement("a", {className: "pull-left  ", id: "hide-annotation"}, "Hide")
            )
        );
    }
});
