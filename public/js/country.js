...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['../../../../public/js/lib/underscore', 'jquery', 'exports'], function (_, $, exports) {
 ...
 */
!function (a, b) {
    "function" == typeof define && define.amd ? define(["underscore", "backbone", "../../../../public/js/lib/jquery"], function (_, Backbone, c) {
    ...
    function c(a, b, c) {
        ...
        d && b.cache !== !1 && (b.cache || b.prefill) && (b.expires !== !1 && (e = (new Date).getTime() + 1e3 * (b.expires || 300)), b.prefillExpires !== !1 && (g = (new Date).getTime() + 1e3 * (b.prefillExpires || 300)), Backbone.fetchCache._cache[d] = {
            expires: e,
            lastSync: f,
            prefillExpires: g,
            value: c
    ...
    function f(a, c) {
        _.isFunction(a) ? a = a() : a && _.isObject(a) && (a = b(a, c)), delete Backbone.fetchCache._cache[a], Backbone.fetchCache.setLocalStorage()
    }

    function g() {
        if (k && Backbone.fetchCache.localStorage)try {
    ...
    function h() {
        if (k && Backbone.fetchCache.localStorage) {
    ...
    var j = {modelFetch: Backbone.Model.prototype.fetch, modelSync: Backbone.Model.prototype.sync, collectionFetch: Backbone.Collection.prototype.fetch}, k = function () {
    ...
    return Backbone.fetchCache = Backbone.fetchCache || {}, Backbone.fetchCache._cache = Backbone.fetchCache._cache || {}, Backbone.fetchCache.enabled = !0, Backbone.fetchCache.priorityFn = function (a, b) {
        ...
        Backbone.fetchCache._cache[this._prioritize()] = null, delete Backbone.fetchCache._cache[this._prioritize()], Backbone.fetchCache.setLocalStorage()
    }, Backbone.fetchCache.getLocalStorageKey = function () {
        return "backboneCache"
    }, "undefined" == typeof Backbone.fetchCache.localStorage && (Backbone.fetchCache.localStorage = !0), Backbone.Model.prototype.fetch = function (b) {
        function c() {
            return b.prefill && (!b.prefillExpires || k)
        }

        function e() {
            b.parse && (l = n.parse(l, b)), n.set(l, b), _.isFunction(b.prefillSuccess) && b.prefillSuccess(n, l, b), n.trigger("cachesync", n, l, b), n.trigger("sync", n, l, b), c() ? m.notify(n) : (_.isFunction(b.success) && b.success(n, l, b), m.resolve(n))
        }

        if (!Backbone.fetchCache.enabled)return j.modelFetch.apply(this, arguments);
        b = _.defaults(b || {}, {parse: !0});
        var f = Backbone.fetchCache.getCacheKey(this, b), g = d(f), h = !1, k = !1, l = !1, m = new a.Deferred, n = this;
        if (g && (h = g.expires, h = h && g.expires < (new Date).getTime(), k = g.prefillExpires, k = k && g.prefillExpires < (new Date).getTime(), l = g.value), !h && (b.cache || b.prefill) && l && (null == b.async && (b.async = !0), b.async ? i(e) : e(), !c()))return m;
        var o = j.modelFetch.apply(this, arguments);
        return o.done(_.bind(m.resolve, this, this)).done(_.bind(Backbone.fetchCache.setCache, null, this, b)).fail(_.bind(m.reject, this, this)), m.abort = o.abort, m
    }, Backbone.Model.prototype.sync = function (a, b, c) {
        if ("read" === a || !Backbone.fetchCache.enabled)return j.modelSync.apply(this, arguments);
        var d, e, g = b.collection, h = [];
        for (h.push(Backbone.fetchCache.getCacheKey(b, c)), g && h.push(Backbone.fetchCache.getCacheKey(g)), d = 0, e = h.length; e > d; d++)f(h[d]);
        return j.modelSync.apply(this, arguments)
        ...
        function e() {
            n[b.reset ? "reset" : "set"](l, b), _.isFunction(b.prefillSuccess) && b.prefillSuccess(n), n.trigger("cachesync", n, l, b), n.trigger("sync", n, l, b), c() ? m.notify(n) : (_.isFunction(b.success) && b.success(n, l, b), m.resolve(n))
        }

        if (!Backbone.fetchCache.enabled)return j.collectionFetch.apply(this, arguments);
        b = _.defaults(b || {}, {parse: !0});
        var f = Backbone.fetchCache.getCacheKey(this, b), g = d(f), h = !1, k = !1, l = !1, m = new a.Deferred, n = this;
        if (g && (h = g.expires, h = h && g.expires < (new Date).getTime(), k = g.prefillExpires, k = k && g.prefillExpires < (new Date).getTime(), l = g.value), !h && (b.cache || b.prefill) && l && (null == b.async && (b.async = !0), b.async ? i(e) : e(), !c()))return m;
        var o = j.collectionFetch.apply(this, arguments);
        return o.done(_.bind(m.resolve, this, this)).done(_.bind(Backbone.fetchCache.setCache, null, this, b)).fail(_.bind(m.reject, this, this)), m.abort = o.abort, m
    }, h(), Backbone.fetchCache._superMethods = j, Backbone.fetchCache.setCache = c, Backbone.fetchCache.getCache = d, Backbone.fetchCache.getCacheKey = b, Backbone.fetchCache.getLastSync = e, Backbone.fetchCache.clearItem = f, Backbone.fetchCache.setLocalStorage = g, Backbone.fetchCache.getLocalStorage = h, Backbone
});
