if (function (t, e) {
        ...
        function w(t) {
            var e = G, n = Mt[t];
            return n || (n = b(t, e), "none" !== n && n || (Ht = (Ht || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Ht[0].contentDocument, e.write(), e.close(), n = b(t, e), Ht.detach()), Mt[t] = n), n
        }

        function x(t, e, n) {
            var i, o, r, s, a = t.style;
            return n = n || Wt(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || J.contains(t.ownerDocument, t) || (s = J.style(t, e)), Ut.test(s) && Ft.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function C(t, e) {
            if (e in t)return e;
            for (var n = e[0].toUpperCase() + e.slice(1), i = e, o = Xt.length; o--;)if (e = Xt[o] + n, e in t)return e;
            return i
        }
        ...
        function E(t, e, n, i, o) {
            for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2)"margin" === n && (s += J.css(t, n + $t[r], !0, o)), i ? ("content" === n && (s -= J.css(t, "padding" + $t[r], !0, o)), "margin" !== n && (s -= J.css(t, "border" + $t[r] + "Width", !0, o))) : (s += J.css(t, "padding" + $t[r], !0, o), "padding" !== n && (s += J.css(t, "border" + $t[r] + "Width", !0, o)));
            return s
        }

        function A(t, e, n) {
            var i = !0, o = "width" === e ? t.offsetWidth : t.offsetHeight, r = Wt(t), s = "border-box" === J.css(t, "boxSizing", !1, r);
            if (0 >= o || null == o) {
                if (o = x(t, e, r), (0 > o || null == o) && (o = t.style[e]), Ut.test(o))return o;
        ...
        function S(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)i = t[s], i.style && (r[s] = vt.get(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ct(i) && (r[s] = vt.access(i, "olddisplay", w(i.nodeName)))) : (o = Ct(i), "none" === n && o || vt.set(i, "olddisplay", o ? n : J.css(i, "display"))));
            for (s = 0; a > s; s++)i = t[s], i.style && (e && "none" !== i.style.display && "" !== i.style.display || (i.style.display = e ? r[s] || "" : "none"));
            return t
        }

        function k(t, e, n, i, o) {
            return new k.prototype.init(t, e, n, i, o)
        }
        ...
        function D(t, e) {
            ...
            for (e = e ? 1 : 0; 4 > i; i += 2 - e)n = $t[i], o["margin" + n] = o["padding" + n] = t;
        ...
        function O(t, e, n) {
            var i, o, r, s, a, l, c, u, d = this, p = {}, h = t.style, f = t.nodeType && Ct(t), g = vt.get(t, "fxshow");
            ...
            })), 1 === t.nodeType && ("height"in e || "width"in e) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], c = J.css(t, "display"), u = "none" === c ? vt.get(t, "olddisplay") || w(t.nodeName) : c, "inline" === u && "none" === J.css(t, "float") && (h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.always(function () {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            }));
            for (i in e)if (o = e[i], Zt.exec(o)) {
            ...
            if (J.isEmptyObject(p))"inline" === ("none" === c ? w(t.nodeName) : c) && (h.display = c); else {
                ...
                for (i in p)s = N(f ? g[i] : 0, i, d), i in g || (g[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }
        ...
        function L(t, e, n) {
            var i, o, r = 0, s = ee.length, a = J.Deferred().always(function () {
                ...
                if (o)return !1;
                for (var e = Kt || _(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++)c.tweens[s].run(r);
            ...
            for (j(u, c.opts.specialEasing); s > r; r++)if (i = ee[r].call(c, t, u, c.opts))return i;
        ...
        function M(t, e, n, i) {
            ...
            if (J.isArray(e))J.each(e, function (e, o) {
                n || Te.test(t) ? i(t, o) : M(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
            }); else if (n || "object" !== J.type(e))i(t, e); else for (o in e)M(t + "[" + o + "]", e[o], n, i)
        }
        ...
        var U = [], W = U.slice, z = U.concat, B = U.push, V = U.indexOf, Y = {}, Q = Y.toString, X = Y.hasOwnProperty, K = {}, G = t.document, Z = "2.1.3", J = function (t, e) {
        ...
        var ot = function (t) {
            function e(t, e, n, i) {
                ...
                if ((e ? e.ownerDocument || e : M) !== O && N(e), e = e || O, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a)return n;
                if (!i && L) {
                    if (11 !== a && (o = yt.exec(t)))if (s = o[1]) {
                        ...
                        if ((s = o[3]) && x.getElementsByClassName)return Z.apply(n, e.getElementsByClassName(s)), n
                    }
                    if (x.qsa && (!q || !q.test(t))) {
                        if (h = d = H, f = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = E(t), (d = e.getAttribute("id")) ? h = d.replace(wt, "\\$&") : e.setAttribute("id", h), h = "[id='" + h + "'] ", l = c.length; l--;)c[l] = h + p(c[l]);
            ...
            function v(t, e, n, o, r, s) {
                return o && !o[H] && (o = v(o)), r && !r[H] && (r = v(r, s)), i(function (i, s, a, l) {
                    var c, u, d, p = [], h = [], f = s.length, v = i || g(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : m(v, p, t, a, l), b = n ? r || (i ? t : f || o) ? [] : s : y;
            ...
            function y(t) {
                for (var e, n, i, o = t.length, r = $.relative[t[0].type], s = r || $.relative[" "], a = r ? 1 : 0, l = h(function (t) {
                    return t === e
                }, s, !0), c = h(function (t) {
                    return tt(e, t) > -1
                    ...
                    return e = null, o
                }]; o > a; a++)if (n = $.relative[t[a].type])u = [h(f(u), n)]; else {
                    if (n = $.filter[t[a].type].apply(null, t[a].matches), n[H]) {
                        for (i = ++a; o > i && !$.relative[t[i].type]; i++);
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, c) {
                    var u, d, p, h = 0, f = "0", g = i && [], v = [], y = k, b = i || r && $.find.TAG("*", c), w = F += null == y ? 1 : Math.random() || .1, x = b.length;
                    for (c && (k = s !== O && s); f !== x && null != (u = b[f]); f++) {
                        if (r && u) {
                            for (d = 0; p = t[d++];)if (p(u, s, a)) {
                                l.push(u);
                                break
                            }
                            c && (F = w)
            ...
            var w, x, $, C, T, E, A, S, k, _, D, N, O, j, L, q, I, R, P, H = "sizzle" + 1 * new Date, M = t.document, F = 0, U = 0, W = n(), z = n(), B = n(), V = function (t, e) {
                return t === e && (D = !0), 0
            }, Y = 1 << 31, Q = {}.hasOwnProperty, X = [], K = X.pop, G = X.push, Z = X.push, J = X.slice, tt = function (t, e) {
            ...
            }, gt = /^(?:input|select|textarea|button)$/i, mt = /^h\d$/i, vt = /^[^{]+\{\s*\[native \w/, yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, wt = /'|\\/g, xt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)", "ig"), $t = function (t, e, n) {
                var i = "0x" + e - 65536;
            ...
            x = e.support = {}, T = e.isXML = function (t) {
                ...
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, j = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), L = !T(i), x.attributes = o(function (t) {
                ...
                }), $.find.TAG = x.getElementsByTagName ? function (t, e) {
                    ...
                    return r
                }, $.find.CLASS = x.getElementsByClassName && function (t, e) {
                        return L ? e.getElementsByClassName(t) : void 0
                    }, I = [], q = [], (x.qsa = vt.test(i.querySelectorAll)) && (o(function (t) {
                ...
                })), (x.matchesSelector = vt.test(R = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && o(function (t) {
                    x.disconnectedMatch = R.call(t, "div"), R.call(t, "[s!='']:x"), I.push("!=", st)
                }), q = q.length && new RegExp(q.join("|")), I = I.length && new RegExp(I.join("|")), e = vt.test(j.compareDocumentPosition), P = e || vt.test(j.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === M && P(M, t) ? -1 : e === i || e.ownerDocument === M && P(M, e) ? 1 : _ ? tt(_, t) - tt(_, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e)return D = !0, 0;
                ...
                if ((t.ownerDocument || t) !== O && N(t), n = n.replace(dt, "='$1']"), x.matchesSelector && L && (!I || !I.test(n)) && (!q || !q.test(n)))try {
                    var i = R.call(t, n);
                ...
                var n = $.attrHandle[e.toLowerCase()], i = n && Q.call($.attrHandle, e.toLowerCase()) ? n(t, e, !L) : void 0;
                return void 0 !== i ? i : x.attributes || !L ? t.getAttribute(e) : (i = t.getAttributeNode(e)) && i.specified ? i.value : null
            }, e.error = function (t) {
                throw new Error("Syntax error, unrecognized expression: " + t)
            }, e.uniqueSort = function (t) {
                var e, n = [], i = 0, o = 0;
                if (D = !x.detectDuplicates, _ = !x.sortStable && t.slice(0), t.sort(V), D) {
                ...
                preFilter: {
                    ATTR: function (t) {
                        return t[1] = t[1].replace(xt, $t), t[3] = (t[3] || t[4] || t[5] || "").replace(xt, $t), "~=" === t[2] && (t[3] = " " + t[3] + " "), t.slice(0, 4)
                    }, CHILD: function (t) {
                ...
                filter: {
                    TAG: function (t) {
                        var e = t.replace(xt, $t).toLowerCase();
                        return "*" === t ? function () {
                            return !0
                        } : function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            var c, u, d, p, h, f, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a;
                            if (m) {
                                if (r) {
                                    for (; g;) {
                                ...
                                if (f = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (u = m[H] || (m[H] = {}), c = u[t] || [], h = c[0] === F && c[1], p = c[0] === F && c[2], d = h && m.childNodes[h]; d = ++h && d && d[g] || (p = h = 0) || f.pop();)if (1 === d.nodeType && ++p && d === e) {
                                        u[t] = [F, h, p];
                                        break
                                    }
                                } else if (y && (c = (e[H] || (e[H] = {}))[t]) && c[0] === F)p = c[1]; else for (; (d = ++h && d && d[g] || (p = h = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[H] || (d[H] = {}))[t] = [F, p]), d !== e)););
                                return p -= o, p === i || p % i === 0 && p / i >= 0
                            }
                        }
                    }, PSEUDO: function (t, n) {
                        var o, r = $.pseudos[t] || $.setFilters[t.toLowerCase()] || e.error("unsupported pseudo: " + t);
                        return r[H] ? r(n) : r.length > 1 ? (o = [t, t, "", n], $.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function (t, e) {
                ...
                pseudos: {
                    not: i(function (t) {
                        ...
                        return t = t.replace(xt, $t), function (e) {
                            return (e.textContent || e.innerText || C(e)).indexOf(t) > -1
                        }
                    }), lang: i(function (t) {
                        return ht.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(xt, $t).toLowerCase(), function (e) {
                            var n;
            ...
            for (w in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0})$.pseudos[w] = a(w);
            for (w in{submit: !0, reset: !0})$.pseudos[w] = l(w);
            return d.prototype = $.filters = $.pseudos, $.setFilters = new d, E = e.tokenize = function (t, n) {
                var i, o, r, s, a, l, c, u = z[t + " "];
                if (u)return n ? 0 : u.slice(0);
                for (a = t, l = [], c = $.preFilter; a;) {
                    (!i || (o = ct.exec(a))) && (o && (a = a.slice(o[0].length) || a), l.push(r = [])), i = !1, (o = ut.exec(a)) && (i = o.shift(), r.push({
                        value: i,
                        type: o[0].replace(lt, " ")
                    }), a = a.slice(i.length));
                    for (s in $.filter)!(o = ft[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(), r.push({value: i, type: s, matches: o}), a = a.slice(i.length));
                    if (!i)break
                }
                ...
                if (!r) {
                    ...
                    r = B(t, b(o, i)), r.selector = t
                }
                return r
            }, S = e.select = function (t, e, n, i) {
                var o, r, s, a, l, c = "function" == typeof t && t, d = !i && E(t = c.selector || t);
                if (n = n || [], 1 === d.length) {
                    if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && x.getById && 9 === e.nodeType && L && $.relative[r[1].type]) {
                        if (e = ($.find.ID(s.matches[0].replace(xt, $t), e) || [])[0], !e)return n;
                        c && (e = e.parentNode), t = t.slice(r.shift().value.length)
                    }
                    for (o = ft.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !$.relative[a = s.type]);)if ((l = $.find[a]) && (i = l(s.matches[0].replace(xt, $t), bt.test(r[0].type) && u(e.parentNode) || e))) {
                        if (r.splice(o, 1), t = i.length && p(r), !t)return Z.apply(n, i), n;
                        break
                    }
                }
                return (c || A(t, d))(i, e, !L, n, bt.test(t) && u(e.parentNode) || e), n
            }, x.sortStable = H.split("").sort(V).join("") === H, x.detectDuplicates = !!D, N(), x.sortDetached = o(function (t) {
        ...
        var rt = J.expr.match.needsContext, st = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, at = /^.[^:#\[\.,]*$/;
        ...
        var lt, ct = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ut = J.fn.init = function (t, e) {
            var n, i;
            if (!t)return this;
            if ("string" == typeof t) {
                if (n = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : ct.exec(t), !n || !n[1] && e)return !e || e.jquery ? (e || lt).find(t) : this.constructor(e).find(t);
                if (n[1]) {
                    if (e = e instanceof J ? e[0] : e, J.merge(this, J.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : G, !0)), st.test(n[1]) && J.isPlainObject(e))for (n in e)J.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                    return this
                }
        ...
        J.extend({
            ...
            has: function (t) {
                ...
                for (var n, i = 0, o = this.length, r = [], s = rt.test(t) || "string" != typeof t ? J(t, e || this.context) : 0; o > i; i++)for (n = this[i]; n && n !== e; n = n.parentNode)if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && J.find.matchesSelector(n, t))) {
                    r.push(n);
                    break
                }
            ...
            J.fn[t] = function (n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = J.filter(i, o)), this.length > 1 && (pt[t] || J.unique(o), dt.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var ht = /\S+/g, ft = {};
        J.Callbacks = function (t) {
            ...
            Deferred: function (t) {
                ...
                var e, n, i, o = 0, r = W.call(arguments), s = r.length, a = 1 !== s || t && J.isFunction(t.promise) ? s : 0, l = 1 === a ? t : J.Deferred(), c = function (t, n, i) {
                    return function (o) {
        ...
        J.fn.ready = function (t) {
            ...
            isReady: !1, readyWait: 1, holdReady: function (t) {
                ...
                (t === !0 ? --J.readyWait : J.isReady) || (J.isReady = !0, t !== !0 && --J.readyWait > 0 || (gt.resolveWith(G, [J]), J.fn.triggerHandler && (J(G).triggerHandler("ready"), J(G).off("ready"))))
            }
        }), J.ready.promise = function (e) {
            return gt || (gt = J.Deferred(), "complete" === G.readyState ? setTimeout(J.ready) : (G.addEventListener("DOMContentLoaded", s, !1), t.addEventListener("load", s, !1))), gt.promise(e)
        }, J.ready.promise();
        ...
        J.acceptData = function (t) {
            ...
            key: function (t) {
                ...
                if (void 0 === e)this.cache[r] = {}; else {
                    J.isArray(e) ? i = e.concat(e.map(J.camelCase)) : (o = J.camelCase(e), e in s ? i = [e, o] : (i = o, i = i in s ? [i] : i.match(ht) || [])), n = i.length;
                    for (; n--;)delete s[i[n]]
                }
            }, hasData: function (t) {
        ...
        var xt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, $t = ["Top", "Right", "Bottom", "Left"], Ct = function (t, e) {
        ...
        var At = /^key/, St = /^(?:mouse|pointer|contextmenu)|click/, kt = /^(?:focusinfocus|focusoutblur)$/, _t = /^([^.]*)(?:\.(.+)|)$/;
        J.event = {
            global: {},
            add: function (t, e, n, i, o) {
                ...
                if (m)for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = J.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                ...
                }), e = (e || "").match(ht) || [""], c = e.length; c--;)a = _t.exec(e[c]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h && (d = J.event.special[h] || {}, h = (o ? d.delegateType : d.bindType) || h, d = J.event.special[h] || {}, u = J.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, r), (p = l[h]) || (p = l[h] = [], p.delegateCount = 0, d.setup && d.setup.call(t, i, f, s) !== !1 || t.addEventListener && t.addEventListener(h, s, !1)), d.add && (d.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, u) : p.push(u), J.event.global[h] = !0)
            },
            remove: function (t, e, n, i, o) {
                var r, s, a, l, c, u, d, p, h, f, g, m = vt.hasData(t) && vt.get(t);
                if (m && (l = m.events)) {
                    for (e = (e || "").match(ht) || [""], c = e.length; c--;)if (a = _t.exec(e[c]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h) {
                        for (d = J.event.special[h] || {}, h = (i ? d.delegateType : d.bindType) || h, p = l[h] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;)u = p[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(r, 1), u.selector && p.delegateCount--, d.remove && d.remove.call(t, u));
            ...
            trigger: function (e, n, i, o) {
                var r, s, a, l, c, u, d, p = [i || G], h = X.call(e, "type") ? e.type : e, f = X.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !kt.test(h + J.event.triggered) && (h.indexOf(".") >= 0 && (f = h.split("."), h = f.shift(), f.sort()), c = h.indexOf(":") < 0 && "on" + h, e = e[J.expando] ? e : new J.Event(h, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : J.makeArray(n, [e]), d = J.event.special[h] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                    if (!o && !d.noBubble && !J.isWindow(i)) {
                        for (l = d.delegateType || h, kt.test(l + h) || (s = s.parentNode); s; s = s.parentNode)p.push(s), a = s;
                        a === (i.ownerDocument || G) && p.push(a.defaultView || a.parentWindow || t)
                    }
                    for (r = 0; (s = p[r++]) && !e.isPropagationStopped();)e.type = r > 1 ? l : d.bindType || h, u = (vt.get(s, "events") || {})[e.type] && vt.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && J.acceptData(s) && (e.result = u.apply(s, n), e.result === !1 && e.preventDefault());
                    return e.type = h, o || e.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !J.acceptData(i) || c && J.isFunction(i[h]) && !J.isWindow(i) && (a = i[c], a && (i[c] = null), J.event.triggered = h, i[h](), J.event.triggered = void 0, a && (i[c] = a)), e.result
                }
            },
            dispatch: function (t) {
                t = J.event.fix(t);
                var e, n, i, o, r, s = [], a = W.call(arguments), l = (vt.get(this, "events") || {})[t.type] || [], c = J.event.special[t.type] || {};
            ...
            mouseHooks: {
                props: "button buttons clientX clientY offsetX offsetY pageX pageY screenX screenY toElement".split(" "), filter: function (t, e) {
            ...
            fix: function (t) {
                ...
                for (s || (this.fixHooks[o] = s = St.test(o) ? this.mouseHooks : At.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new J.Event(r), e = i.length; e--;)n = i[e], t[n] = r[n];
        ...
        var Dt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Nt = /<([\w:]+)/, Ot = /<|&#?\w+;/, jt = /<(?:script|style|link)/i, Lt = /checked\s*(?:[^=]|=\s*.checked.)/i, qt = /^$|\/(?:java|ecma)script/i, It = /^true\/(.*)/, Rt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Pt = {
        ...
        Pt.optgroup = Pt.option, Pt.tbody = Pt.tfoot = Pt.colgroup = Pt.caption = Pt.thead, Pt.th = Pt.td, J.extend({
            clone: function (t, e, n) {
                ...
                if (!(K.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || J.isXMLDoc(t)))for (s = v(a), r = v(t), i = 0, o = r.length; o > i; i++)y(r[i], s[i]);
                ...
                for (var o, r, s, a, l, c, u = e.createDocumentFragment(), d = [], p = 0, h = t.length; h > p; p++)if (o = t[p], o || 0 === o)if ("object" === J.type(o))J.merge(d, o.nodeType ? [o] : o); else if (Ot.test(o)) {
                    for (r = r || u.appendChild(e.createElement("div")), s = (Nt.exec(o) || ["", ""])[1].toLowerCase(), a = Pt[s] || Pt._default, r.innerHTML = a[1] + o.replace(Dt, "<$1></$2>") + a[2], c = a[0]; c--;)r = r.lastChild;
                    J.merge(d, r.childNodes), r = u.firstChild, r.textContent = ""
                } else d.push(e.createTextNode(o));
                for (u.textContent = "", p = 0; o = d[p++];)if ((!i || -1 === J.inArray(o, i)) && (l = J.contains(o.ownerDocument, o), r = v(u.appendChild(o), "script"), l && g(r), n))for (c = 0; o = r[c++];)qt.test(o.type || "") && n.push(o);
                return u
            ...
            text: function (t) {
                ...
                return mt(this, function (t) {
                    ...
                    if ("string" == typeof t && !jt.test(t) && !Pt[(Nt.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(Dt, "<$1></$2>");
                        try {
                ...
                t = z.apply([], t);
                var n, i, o, r, s, a, l = 0, c = this.length, u = this, d = c - 1, p = t[0], g = J.isFunction(p);
                if (g || c > 1 && "string" == typeof p && !K.checkClone && Lt.test(p))return this.each(function (n) {
                    var i = u.eq(n);
                ...
                if (c && (n = J.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    for (o = J.map(v(n, "script"), h), r = o.length; c > l; l++)s = n, l !== d && (s = J.clone(s, !0, !0), r && J.merge(o, v(s, "script"))), e.call(this[l], s, l);
                    if (r)for (a = o[o.length - 1].ownerDocument, J.map(o, f), l = 0; r > l; l++)s = o[l], qt.test(s.type || "") && !vt.access(s, "globalEval") && J.contains(a, s) && (s.src ? J._evalUrl && J._evalUrl(s.src) : J.globalEval(s.textContent.replace(Rt, "")))
                }
                return this
            }
        ...
        var Ht, Mt = {}, Ft = /^margin/, Ut = new RegExp("^(" + xt + ")(?!px)[a-z%]+$", "i"), Wt = function (e) {
        ...
        var zt = /^(none|table(?!-c[ea]).+)/, Bt = new RegExp("^(" + xt + ")(.*)$", "i"), Vt = new RegExp("^([+-])=(" + xt + ")", "i"), Yt = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        }, Qt = {letterSpacing: "0", fontWeight: "400"}, Xt = ["Webkit", "O", "Moz", "ms"];
        J.extend({
            cssHooks: {
                opacity: {
                    get: function (t, e) {
            ...
            style: function (t, e, n, i) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    return e = J.cssProps[a] || (J.cssProps[a] = C(l, a)), s = J.cssHooks[e] || J.cssHooks[a], void 0 === n ? s && "get"in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n, "string" === r && (o = Vt.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(J.css(t, e)), r = "number"), null != n && n === n && ("number" !== r || J.cssNumber[a] || (n += "px"), K.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set"in s && void 0 === (n = s.set(t, n, i)) || (l[e] = n)), void 0)
                }
            },
            css: function (t, e, n, i) {
                var o, r, s, a = J.camelCase(e);
                return e = J.cssProps[a] || (J.cssProps[a] = C(t.style, a)), s = J.cssHooks[e] || J.cssHooks[a], s && "get"in s && (o = s.get(t, !0, n)), void 0 === o && (o = x(t, e, i)), "normal" === o && e in Qt && (o = Qt[e]), "" === n || n ? (r = parseFloat(o), n === !0 || J.isNumeric(r) ? r || 0 : o) : o
            }
        }), J.each(["height", "width"], function (t, e) {
            J.cssHooks[e] = {
                get: function (t, n, i) {
                    return n ? zt.test(J.css(t, "display")) && 0 === t.offsetWidth ? J.swap(t, Yt, function () {
                        return A(t, e, i)
                    }) : A(t, e, i) : void 0
                }, set: function (t, n, i) {
                    var o = i && Wt(t);
                    return T(t, n, i ? E(t, e, i, "border-box" === J.css(t, "boxSizing", !1, o), o) : 0)
                }
            }
        }), J.cssHooks.marginRight = $(K.reliableMarginRight, function (t, e) {
            ...
            }, Ft.test(t) || (J.cssHooks[t + e].set = T)
        }), J.fn.extend({
            css: function (t, e) {
                return mt(this, function (t, e, n) {
                    var i, o, r = {}, s = 0;
                    if (J.isArray(e)) {
                        for (i = Wt(t), o = e.length; o > s; s++)r[e[s]] = J.css(t, e[s], !1, i);
                        return r
                    }
            ...
            constructor: k, init: function (t, e, n, i, o, r) {
                ...
                return this.options.duration ? this.pos = e = J.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : k.propHooks._default.set(this), this
            }
        ...
        var Kt, Gt, Zt = /^(?:toggle|show|hide)$/, Jt = new RegExp("^(?:([+-])=|)(" + xt + ")([a-z%]*)$", "i"), te = /queueHooks$/, ee = [O], ne = {
            "*": [function (t, e) {
                var n = this.createTween(t, e), i = n.cur(), o = Jt.exec(e), r = o && o[3] || (J.cssNumber[t] ? "" : "px"), s = (J.cssNumber[t] || "px" !== r && +i) && Jt.exec(J.css(n.elem, t)), a = 1, l = 20;
                if (s && s[3] !== r) {
                    r = r || s[3], o = o || [], s = +i || 1;
        ...
        J.Animation = J.extend(L, {
            ...
            fadeTo: function (t, e, n, i) {
                ...
                return "string" != typeof t && (n = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function () {
                    var e = !0, o = null != t && t + "queueHooks", r = J.timers, s = vt.get(this);
                ...
                return t !== !1 && (t = t || "fx"), this.each(function () {
                    ...
                    for (n.finish = !0, J.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = r.length; e--;)r[e].elem === this && r[e].queue === t && (r[e].anim.stop(!0),
                        r.splice(e, 1));
        ...
        }), J.each({slideDown: D("show"), slideUp: D("hide"), slideToggle: D("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (t, e) {
            J.fn[t] = function (t, n, i) {
                return this.animate(e, t, n, i)
            }
        }), J.timers = [], J.fx.tick = function () {
            var t, e = 0, n = J.timers;
            for (Kt = J.now(); e < n.length; e++)t = n[e], t() || n[e] !== t || n.splice(e--, 1);
        ...
        J.fn.extend({
            ...
            attr: function (t, e, n) {
                ...
                if (t && 3 !== r && 8 !== r && 2 !== r)return typeof t.getAttribute === Et ? J.prop(t, e, n) : (1 === r && J.isXMLDoc(t) || (e = e.toLowerCase(), i = J.attrHooks[e] || (J.expr.match.bool.test(e) ? oe : ie)), void 0 === n ? i && "get"in i && null !== (o = i.get(t, e)) ? o : (o = J.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set"in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void J.removeAttr(t, e))
        ...
        J.fn.extend({
            addClass: function (t) {
                ...
                if (a)for (e = (t || "").match(ht) || []; c > l; l++)if (n = this[l], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(ae, " ") : " ")) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : J.isFunction(t) ? this.each(function (n) {
                    ...
                    if ("string" === n)for (var e, i = 0, o = J(this), r = t.match(ht) || []; e = r[i++];)o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else(n === Et || "boolean" === n) && (this.className && vt.set(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : vt.get(this, "__className__") || "")
                })
            }, hasClass: function (t) {
        ...
        J.fn.extend({
            val: function (t) {
                var e, n, i, o = this[0];
                {
                    ...
                    if (o)return e = J.valHooks[o.type] || J.valHooks[o.nodeName.toLowerCase()], e && "get"in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(le, "") : null == n ? "" : n)
                }
            }
        }), J.extend({
            valHooks: {
                option: {
                    ...
                    get: function (t) {
                        for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)if (n = i[l], (n.selected || l === o) && (K.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !J.nodeName(n.parentNode, "optgroup"))) {
        ...
        var de = /#.*$/, pe = /([?&])_=[^&]*/, he = /^(.*?):[ \t]*([^\r\n]*)$/gm, fe = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, ge = /^(?:GET|HEAD)$/, me = /^\/\//, ve = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, ye = {}, be = {}, we = "*/".concat("*"), xe = t.location.href, $e = ve.exec(xe.toLowerCase()) || [];
        J.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ...
            ajax: function (t, e) {
                function n(t, e, n, s) {
                    var l, u, v, y, w, $ = e;
                    2 !== b && (b = 2, a && clearTimeout(a), i = void 0, r = s || "", x.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (y = P(d, x, n)), y = H(d, y, x, l), l ? (d.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (J.lastModified[o] = w), w = x.getResponseHeader("etag"), w && (J.etag[o] = w)), 204 === t || "HEAD" === d.type ? $ = "nocontent" : 304 === t ? $ = "notmodified" : ($ = y.state, u = y.data, v = y.error, l = !v)) : (v = $, (t || !$) && ($ = "error", 0 > t && (t = 0))), x.status = t, x.statusText = (e || $) + "", l ? f.resolveWith(p, [u, $, x]) : f.rejectWith(p, [x, $, v]), x.statusCode(m), m = void 0, c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [x, d, l ? u : v]), g.fireWith(p, [x, $]), c && (h.trigger("ajaxComplete", [x, d]), --J.active || J.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var i, o, r, s, a, l, c, u, d = J.ajaxSetup({}, e), p = d.context || d, h = d.context && (p.nodeType || p.jquery) ? J(p) : J.event, f = J.Deferred(), g = J.Callbacks("once memory"), m = d.statusCode || {}, v = {}, y = {}, b = 0, w = "canceled", x = {
                    readyState: 0,
                    getResponseHeader: function (t) {
                        var e;
                        if (2 === b) {
                            if (!s)for (s = {}; e = he.exec(r);)s[e[1].toLowerCase()] = e[2];
                            e = s[t.toLowerCase()]
                        }
                ...
                if (f.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((t || d.url || xe) + "").replace(de, "").replace(me, $e[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = J.trim(d.dataType || "*").toLowerCase().match(ht) || [""], null == d.crossDomain && (l = ve.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === $e[1] && l[2] === $e[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === ($e[3] || ("http:" === $e[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = J.param(d.data, d.traditional)), I(ye, d, e, x), 2 === b)return x;
            ...
            J[e] = function (t, n, i, o) {
                return J.isFunction(n) && (o = o || i, i = n, n = void 0), J.ajax({url: t, type: e, dataType: o, data: n, success: i})
            }
        ...
        var Ce = /%20/g, Te = /\[\]$/, Ee = /\r?\n/g, Ae = /^(?:submit|button|image|reset|file)$/i, Se = /^(?:input|select|textarea|keygen)/i;
        J.param = function (t, e) {
            ...
            serialize: function () {
                ...
                return this.map(function () {
                    ...
                    var t = this.type;
                    return this.name && !J(this).is(":disabled") && Se.test(this.nodeName) && !Ae.test(t) && (this.checked || !Tt.test(t))
                }).map(function (t, e) {
                    var n = J(this).val();
        ...
        var ke = 0, _e = {}, De = {0: 200, 1223: 204}, Ne = J.ajaxSettings.xhr();
        t.attachEvent && t.attachEvent("onunload", function () {
            for (var t in _e)_e[t]()
        }), K.cors = !!Ne && "withCredentials"in Ne, K.ajax = Ne = !!Ne, J.ajaxTransport(function (t) {
            var e;
            return K.cors || Ne && !t.crossDomain ? {
                send: function (n, i) {
                    var o, r = t.xhr(), s = ++ke;
                    ...
                    e = function (t) {
                        return function () {
                            e && (delete _e[s], e = r.onload = r.onerror = null, "abort" === t ? r.abort() : "error" === t ? i(r.status, r.statusText) : i(De[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {text: r.responseText} : void 0, r.getAllResponseHeaders()))
                        }
            ...
            if (t.crossDomain) {
                ...
                return {
                    send: function (i, o) {
                        e = J("<script>").prop({async: !0, charset: t.scriptCharset, src: t.url}).on("load error", n = function (t) {
        ...
        J.ajaxSetup({
            jsonp: "callback", jsonpCallback: function () {
                var t = Oe.pop() || J.expando + "_" + ce++;
                return this[t] = !0, t
            }
        }), J.ajaxPrefilter("json jsonp", function (e, n, i) {
            var o, r, s, a = e.jsonp !== !1 && (je.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && je.test(e.data) && "data");
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = J.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(je, "$1" + o) : e.jsonp !== !1 && (e.url += (ue.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
                return s || J.error(o + " was not called"), s[0]
            }, e.dataTypes[0] = "json", r = t[o], t[o] = function () {
                s = arguments
            }, i.always(function () {
                t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, Oe.push(o)), s && J.isFunction(r) && r(s[0]), s = r = void 0
            }), "script") : void 0
        ...
        J.offset = {
            setOffset: function (t, e, n) {
                var i, o, r, s, a, l, c, u = J.css(t, "position"), d = J(t), p = {};
                "static" === u && (t.style.position = "relative"), a = d.offset(), r = J.css(t, "top"), l = J.css(t, "left"), c = ("absolute" === u || "fixed" === u) && (r + l).indexOf("auto") > -1, c ? (i = d.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), J.isFunction(e) && (e = e.call(t, n, a)), null != e.top && (p.top = e.top - a.top + s), null != e.left && (p.left = e.left - a.left + o), "using"in e ? e.using.call(t, p) : d.css(p)
            }
        }, J.fn.extend({
            offset: function (t) {
                ...
                if (r)return e = r.documentElement, J.contains(e, i) ? (typeof i.getBoundingClientRect !== Et && (o = i.getBoundingClientRect()), n = F(r), {
                ...
                return this.map(function () {
                    for (var t = this.offsetParent || qe; t && !J.nodeName(t, "html") && "static" === J.css(t, "position");)t = t.offsetParent;
                    return t || qe
                })
            }
            ...
            J.cssHooks[e] = $(K.pixelPosition, function (t, n) {
        ...
        var Ie = t.jQuery, Re = t.$;
        return J.noConflict = function (e) {
            return t.$ === J && (t.$ = Re), e && t.jQuery === J && (t.jQuery = Ie), J
...
+function (t) {
    ...
    n.VERSION = "3.3.4", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (c) {
                ...
                a = "bottom" == a && u.bottom + p > g.bottom ? "top" : "top" == a && u.top - p < g.top ? "bottom" : "right" == a && u.right + d > g.width ? "left" : "left" == a && u.left - d < g.left ? "right" : a, r.removeClass(h).addClass(a)
            }
        ...
        var r = i ? {top: 0, left: 0} : e.offset(), s = {scroll: i ? document.documentElement.scrollTop || document.body.scrollTop : e.scrollTop()}, a = i ? {
        ...
        } : "left" == t ? {top: e.top + e.height / 2 - i / 2, left: e.left - n} : {top: e.top + e.height / 2 - i / 2, left: e.left + e.width}
        ...
        return function () {
            if (!e || !e.requirejs) {
                ...
                !function (e) {
                    ...
                    function r(t, e) {
                        var n, i, o, r, s, a, l, c, u, d, p, h = e && e.split("/"), f = y.map, g = f && f["*"] || {};
                        if (t && "." === t.charAt(0))if (e) {
                            for (h = h.slice(0, h.length - 1), t = t.split("/"), s = t.length - 1, y.nodeIdCompat && $.test(t[s]) && (t[s] = t[s].replace($, "")), t = h.concat(t), u = 0; u < t.length; u += 1)if (p = t[u], "." === p)t.splice(u, 1), u -= 1; else if (".." === p) {
                        ...
                        if ((h || g) && f) {
                            for (n = t.split("/"), u = n.length; u > 0; u -= 1) {
                                if (i = n.slice(0, u).join("/"), h)for (d = h.length; d > 0; d -= 1)if (o = f[h.slice(0, d).join("/")], o && (o = o[i])) {
                                    r = o, a = u;
                                    break
                                }
                                if (r)break;
                    ...
                    function s(t, n) {
                        return function () {
                            return h.apply(e, x.call(arguments, 0).concat([t, n]))
                        }
                    }
                    ...
                    var p, h, f, g, m = {}, v = {}, y = {}, b = {}, w = Object.prototype.hasOwnProperty, x = [].slice, $ = /\.js$/;
                    f = function (t, e) {
                        var n, i = u(t), o = i[0];
                        return t = i[1], o && (o = r(o, e), n = c(o)), o ? t = n && n.normalize ? n.normalize(t, a(e)) : r(t, e) : (t = r(t, e), i = u(t), o = i[0], t = i[1], o && (n = c(o))), {
                            f: o ? o + "!" + t : t,
                            n: t,
                            pr: o,
                            p: n
                        ...
                        require: function (t) {
                            ...
                            return {id: t, uri: "", exports: m[t], config: d(t)}
                        }
                    }, p = function (t, n, i, r) {
                        var a, u, d, p, h, y, w = [], x = typeof i;
                        if (r = r || t, "undefined" === x || "function" === x) {
                            for (n = !n.length && i.length ? ["require", "exports", "module"] : n, h = 0; h < n.length; h += 1)if (p = f(n[h], r), u = p.f, "require" === u)w[h] = g.require(t); else if ("exports" === u)w[h] = g.exports(t), y = !0; else if ("module" === u)a = w[h] = g.module(t); else if (o(m, u) || o(v, u) || o(b, u))w[h] = c(u); else {
                                if (!p.p)throw new Error(t + " missing " + u);
                                p.p.load(p.n, s(r, !0), l(u), {}), w[h] = m[u]
                            }
                            d = i ? i.apply(m[t], w) : void 0, t && (a && a.exports !== e && a.exports !== m[t] ? m[t] = a.exports : d === e && y || (m[t] = d))
                        } else t && (m[t] = i)
                    }, t = n = h = function (t, n, i, o, r) {
                        if ("string" == typeof t)return g[t] ? g[t](n) : c(f(t, n).f);
                        if (!t.splice) {
                            if (y = t, y.deps && h(y.deps, y.callback), !n)return;
                            n.splice ? (t = n, n = i, i = null) : t = e
                        }
                        return n = n || function () {
                            }, "function" == typeof i && (i = o, o = r), o ? p(e, t, n, i) : setTimeout(function () {
                            p(e, t, n, i)
                        }, 4), h
                    }, h.config = function (t) {
                        return h(t)
                    }, t._defined = m, i = function (t, e, n) {
                        e.splice || (n = e, e = []), o(m, t) || o(v, t) || (v[t] = [t, e, n])
                    }, i.amd = {jQuery: !0}
            ...
            return i.prototype.on = function (t, e) {
                ...
                return o !== r || "hidden" !== r && "visible" !== r ? "scroll" === o || "scroll" === r ? !0 : i.innerHeight() < n.scrollHeight || i.innerWidth() < n.scrollWidth : !1
            ...
            return e.Extend(n, e.Observable), n.prototype.render = function () {
                ...
                var i = t('<li role="treeitem" class="select2-results__option"></li>'), o = this.options.get("translations").get(e.message);
                ...
                this.hideLoading();
                var e = this.options.get("translations").get("searching"), n = {disabled: !0, loading: !0, text: e(t)}, i = this.option(n);
                ...
                e.disabled && (delete i["aria-selected"], i["aria-disabled"] = "true"), null == e.id && delete i["aria-selected"], null != e._resultId && (n.id = e._resultId), e.title && (n.title = e.title),
                ...
                this.$results.attr("id", o), e.on("results:all", function (t) {
                    ...
                    var t = i.getHighlightedResults(), e = i.$results.find("[aria-selected]"), n = e.index(t), o = n + 1;
                    if (!(o >= e.length)) {
                        var r = e.eq(o);
                        r.trigger("mouseenter");
                        var s = i.$results.offset().top + i.$results.outerHeight(!1), a = r.offset().top + r.outerHeight(!1), l = i.$results.scrollTop() + a - s;
                    ...
                    var e = i.$results.scrollTop(), n = i.$results.get(0).scrollHeight - i.$results.scrollTop() + t.deltaY, o = t.deltaY > 0 && e - t.deltaY <= 0, r = t.deltaY < 0 && n <= i.$results.height();
                ...
                if (0 !== t.length) {
                    var e = this.$results.find("[aria-selected]"), n = e.index(t), i = this.$results.offset().top, o = t.offset().top, r = this.$results.scrollTop() + (o - i), s = o - i;
                    r -= 2 * t.outerHeight(!1), 2 >= n ? this.$results.scrollTop(0) : (s > this.$results.outerHeight() || 0 > s) && this.$results.scrollTop(r)
                }
            }, n.prototype.template = function (e, n) {
                var i = this.options.get("templateResult"), o = this.options.get("escapeMarkup"), r = i(e);
            ...
            return n.Extend(i, e), i.prototype.render = function () {
                ...
                i.__super__.bind.apply(this, arguments), this.$selection.on("click", function (t) {
                    ...
                    var n = t(this), i = n.parent(), r = i.data("data");
                ...
                if (this.clear(), 0 !== t.length) {
                    for (var e = [], i = 0; i < t.length; i++) {
                        var o = t[i], r = this.display(o), s = this.selectionContainer();
            ...
            return e.prototype.bind = function (e, n, i) {
                var o = this, r = ["open", "opening", "close", "closing", "select", "selecting", "unselect", "unselecting"], s = ["opening", "closing", "selecting", "unselecting"];
            ...
            return e.Extend(i, t), i.prototype.current = function (t) {
                ...
                r.each(function () {
                    ...
                    if (e.is("option") || e.is("optgroup")) {
                        var r = o.item(e), s = o.matches(t, r);
                        null !== s && i.push(s)
                    }
                }), e({results: i})
                ...
                if (t.is("option"))e = {id: t.val(), text: t.text(), disabled: t.prop("disabled"), selected: t.prop("selected"), title: t.prop("title")}; else if (t.is("optgroup")) {
            ...
            return e.Extend(i, t), i.prototype.select = function (t) {
                ...
                for (var o = this, r = this.$element.find("option"), s = r.map(function () {
                    ...
                    if (n.inArray(c.id, s) >= 0) {
                        var u = r.filter(i(c)), d = this.item(u), p = (n.extend(!0, {}, d, c), this.option(d));
                        u.replaceWith(p)
                    } else {
                        var h = this.option(c);
                        if (c.children) {
            ...
            return e.Extend(i, t), i.prototype._applyDefaults = function (t) {
                ...
                "function" == typeof r.url && (r.url = r.url(t)), "function" == typeof r.data && (r.data = r.data(t)), this.ajaxOptions.delay && "" !== t.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), this._queryTimeout = window.setTimeout(i, this.ajaxOptions.delay)) : i()
            }, i
        }), e.define("select2/data/tags", ["jquery"], function (t) {
            function e(e, n, i) {
                var o = i.get("tags"), r = i.get("createTag");
                if (void 0 !== r && (this.createTag = r), e.call(this, n, i), t.isArray(o))for (var s = 0; s < o.length; s++) {
                    var a = o[s], l = this._normalizeItem(a), c = this.option(l);
            ...
            return e.prototype.query = function (t, e, n) {
                function i(t, r) {
                    ...
                    if (null != d) {
                        var p = o.option(d);
                        p.attr("data-select2-tag", !0), o.addOptions([p]), o.insertTag(s, d)
                    }
                    t.results = s, n(t)
                }
            ...
            return e.prototype.bind = function (t, e, n) {
                ...
                r.term !== e.term && (this.$search.length && (this.$search.val(r.term), this.$search.focus()), e.term = r.term), t.call(this, e, n)
                ...
                for (var r = i.get("tokenSeparators") || [], s = n.term, a = 0, l = this.createTag || function (t) {
                    ...
                    var c = s[a];
                    if (-1 !== t.inArray(c, r)) {
                        var u = s.substr(0, a), d = t.extend({}, n, {term: u}), p = l(d);
            ...
            return e.prototype.append = function (t, e) {
                ...
                e.call(this, n, i), n.on("query", function (t) {
                    ...
                    if (!o.loading && e) {
                        var n = o.$results.offset().top + o.$results.outerHeight(!1), i = o.$loadingMore.offset().top + o.$loadingMore.outerHeight(!1);
                        n + 50 >= i && o.loadMore()
                    }
                })
            ...
            return n.prototype.bind = function (t, e, n) {
                ...
                var i = this, o = "scroll.select2." + n.id, r = "resize.select2." + n.id, s = "orientationchange.select2." + n.id, a = this.$container.parents().filter(e.hasScroll);
                a.each(function () {
                ...
                var i = "scroll.select2." + n.id, o = "resize.select2." + n.id, r = "orientationchange.select2." + n.id, s = this.$container.parents().filter(e.hasScroll);
                s.off(i), t(window).off(i + " " + o + " " + r)
            }, n.prototype._positionDropdown = function () {
                var e = t(window), n = this.$dropdown.hasClass("select2-dropdown--above"), i = this.$dropdown.hasClass("select2-dropdown--below"), o = null, r = (this.$container.position(), this.$container.offset());
                ...
                }, c = l.top < r.top - a.height, u = l.bottom > r.bottom + a.height, d = {left: r.left, top: s.bottom};
            ...
            _.prototype.apply = function (d) {
                if (d = t.extend({}, this.defaults, d), null == d.dataAdapter) {
                    ...
                    if (null != d.initSelection) {
                        var _ = e(d.amdBase + "compat/initSelection");
                        d.dataAdapter = c.Decorate(d.dataAdapter, _)
                    }
                }
                if (null == d.resultsAdapter && (d.resultsAdapter = n, null != d.ajax && (d.resultsAdapter = c.Decorate(d.resultsAdapter, C)), null != d.placeholder && (d.resultsAdapter = c.Decorate(d.resultsAdapter, $)), d.selectOnClose && (d.resultsAdapter = c.Decorate(d.resultsAdapter, A))), null == d.dropdownAdapter) {
                ...
                if ("string" == typeof d.language)if (d.language.indexOf("-") > 0) {
                    var j = d.language.split("-"), L = j[0];
                    d.language = [d.language, L]
                } else d.language = [d.language];
                if (t.isArray(d.language)) {
                    var q = new u;
                    d.language.push("en");
                    for (var I = d.language, R = 0; R < I.length; R++) {
                        var P = I[R], H = {};
                        try {
                            H = u.loadPath(P)
                        } catch (M) {
            ...
            return n.Extend(o, n.Observable), o.prototype._generateId = function (t) {
                ...
                null != i ? (this._observer = new i(function (n) {
                    t.each(n, e._sync)
                }), this._observer.observe(this.$element[0], {attributes: !0, subtree: !1})) : this.$element[0].addEventListener && this.$element[0].addEventListener("DOMAttrModified", e._sync, !1)
                ...
                var n = o.__super__.trigger, i = {open: "opening", close: "closing", select: "selecting", unselect: "unselecting"};
                if (t in i) {
                    var r = i[t], s = {prevented: !1, name: t, args: e};
            ...
            if (e("jquery.mousewheel"), null == t.fn.select2) {
                ...
                t.fn.select2 = function (e) {
                    ...
                    if ("string" == typeof e) {
                        ...
                        var r = Array.prototype.slice.call(arguments, 1), s = i[e](r);
    ...
    $("select").length && -$("select").select2({
        placeholder: lang.select, allowClear: !0, theme: "classic", language: {
            noResults: function () {
    ...
    var t = $("[data-toggle=collapse-side]"), e = t.attr("data-target"), n = t.attr("data-target-2");
    t.click(function (t) {
        $(this).toggleClass("active"), $(e).toggleClass("in"), $(n).toggleClass("out"), $(n).find(".col-lg-2,.col-lg-3").toggleClass("col-lg-2").toggleClass("col-lg-3"), $(n).find(".col-lg-4,.col-lg-6").toggleClass("col-lg-4").toggleClass("col-lg-6");
        var i = $(".side-collapse-container").height();
        $(".side-collapse").height(i), $("input.resource").on("click", function () {
            $("#countries > .col-lg-3").addClass("toggle-width")
        }), $(window).width() < 1200 && $(n).find(".col-md-3,.col-md-6").toggleClass("col-md-3").toggleClass("col-md-6"), $(window).width() < 992 && $(n).find(".col-sm-4,.col-sm-6").toggleClass("col-sm-4").toggleClass("col-sm-6"), $(window).width() < 768 && $(n).find(".col-xs-6,.col-xs-12").toggleClass("col-xs-6").toggleClass("col-xs-12"), $(window).resize(function () {
            $(window).width() < 1200 && $(n).find(".col-md-3,.col-md-6").toggleClass("col-md-6").toggleClass("col-md-3"), $(window).width() < 992 && $(n).find(".col-sm-4,.col-sm-6").toggleClass("col-sm-4").toggleClass("col-sm-6"), $(window).width() < 768 && $(n).find(".col-xs-6,.col-xs-12").toggleClass("col-xs-6").toggleClass("col-xs-12")
        })
    });
    var i = $("[data-toggle=collapse-sidebar]"), o = i.attr("data-target"), r = i.attr("data-target-2");
    if (i.click(function (t) {
            $(this).toggleClass("active"), $(o).toggleClass("in"), $(r).toggleClass("out")
        }), $(".view-annotation").on("click", function (t) {
            var e = $(this).attr("href");
            $(".category-wrap").show(), $(".cluster-wrap").show(), t.preventDefault(), $("html, body").animate({scrollTop: $(this.hash).offset().top}, 300, function () {
                window.location.hash = e
            })
        }), $(".view-annotation-category").on("click", function (t) {
            var e = $(this).attr("href");
            t.preventDefault(), $(".cluster-wrap").show(), $(".view-annotation-cluster").removeClass("active"), $(".annotation-category-cluster li:first-child a").addClass("active"), $("html, body").animate({scrollTop: $(this.hash).offset().top - 25}, 300, function () {
                window.location.hash = e
            })
        }), $('#search-form:not(.search-page-form) input[type="text"]').focus(function () {
            $(".search-input-wrapper").show(), $(".contract-number-wrap").hide()
        }), $(document).on("click", ".search-close", function () {
            $(".search-input-wrapper").hide(), $(".contract-number-wrap").show()
        }), $('#search-form input[type="text"]').keyup(function () {
            "" == $(this).val() ? ($(".search-input-wrapper").hide(), $(".contract-number-wrap").show()) : ($(".search-input-wrapper").show(), $(".contract-number-wrap").hide())
        }), $(".download-wrap,.view-pin-wrap").click(function () {
            $(this).siblings("ul").toggle()
        }), $(".search-click").click(function () {
            $('#search-form input[type="text"]').focus()
        }), $(window).width() > 992) {
        var s = $(".col-lg-6 .panel-contract-wrap").height();
        $(".panel-annotation-wrap").css("height", s)
    } else $(".panel-annotation-wrap").css("height", "auto");
    if ($(window).on("resize", function () {
            if ($(window).width() > 992) {
                var t = $(".col-lg-6 .panel-contract-wrap").height();
                $(".panel-annotation-wrap").css("height", t)
            } else $(".panel-annotation-wrap").css("height", "auto")
        }), $(window).width() > 992) {
        var a = $(".country-detail-wrapper").height() + 10;
        $(".country-contract-wrap").css("height", a)
    } else $(".country-contract-wrap").css("height", "auto");
    $(window).on("resize", function () {
        if ($(window).width() > 992) {
            var t = $(".country-detail-wrapper").height() + 10;
            $(".country-contract-wrap").css("height", t)
        } else $(".country-contract-wrap").css("height", "auto")
    }), $("#no-pin-message").each(function () {
        $(this).text().trim().length || $(this).parents(".pin-list").css("display", "none")
    }), $(document).click(function (t) {
        $(t.target).closest(".download-wrap, .dropdown-menu").length || $(".dropdown-menu").hide(), $(t.target).closest(".view-pin-wrap, #pinLists").length || $("#pinLists").hide()
    }), $(document).on("click", ".toggle-all", function (t) {
        t.preventDefault();
        var e = $(this).attr("href");
        $(e).slideToggle(), $(this).text(function (t, e) {
            return "More" == e ? "Less" : "More"
        })
    }), $(".sidebar-nav li ul").each(function () {
        $(this).text().trim().length || $(this).parent("li").css("display", "none")
    }), $(document).on("click", ".view-annotation-cluster", function (t) {
        t.preventDefault();
        var e = $(this).attr("href");
        $(".annotation-category-cluster .active").removeClass("active"), $(this).addClass("active"), "#cluster-all" == e ? $(".cluster-wrap").show() : ($(".cluster-wrap").hide(), $(e).show())
    })
}), $(function () {
    ...
    var t = window.location, e = $("ul.nav a").filter(function () {
