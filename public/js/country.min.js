(function () {
    function t(t) {
        ...
        return function (n, r, i, s) {
            r = _(r, s, 4);
            var o = !E(n) && y.keys(n), a = (o || n).length, c = t > 0 ? 0 : a - 1;
            return arguments.length < 3 && (i = n[o ? o[c] : c], c += t), e(n, r, i, o, c, a)
        }
    }
    ...
    function e(t) {
        return function (e, n, r) {
            n = b(n, r);
            for (var i = k(e), s = t > 0 ? 0 : i - 1; s >= 0 && i > s; s += t)if (n(e[s], s, e))return s;
            return -1
        }
    }
    ...
    function n(t, e, n) {
        return function (r, i, s) {
            ...
            if (i !== i)return s = e(l.call(r, o, a), y.isNaN), s >= 0 ? s + o : -1;
            for (s = t > 0 ? o : a - 1; s >= 0 && a > s; s += t)if (r[s] === i)return s;
            return -1
        }
    }

    function r(t, e) {
        var n = F.length, r = t.constructor, i = y.isFunction(r) && r.prototype || a, s = "constructor";
        for (y.has(t, s) && !y.contains(e, s) && e.push(s); n--;)s = F[n], s in t && t[s] !== i[s] && !y.contains(e, s) && e.push(s)
    }

    var i = this, s = i._, o = Array.prototype, a = Object.prototype, c = Function.prototype, u = o.push, l = o.slice, h = a.toString, f = a.hasOwnProperty, d = Array.isArray, p = Object.keys, g = c.bind, v = Object.create, m = function () {
    }, y = function (t) {
    ...
    var x = function (t, e) {
        return function (n) {
            ...
            for (var i = 1; r > i; i++)for (var s = arguments[i], o = t(s), a = o.length, c = 0; a > c; c++) {
                var u = o[c];
    ...
    }, S = Math.pow(2, 53) - 1, k = C("length"), E = function (t) {
        var e = k(t);
    ...
    y.each = y.forEach = function (t, e, n) {
        e = _(e, n);
        var r, i;
        if (E(t))for (r = 0, i = t.length; i > r; r++)e(t[r], r, t); else {
            var s = y.keys(t);
        ...
        e = b(e, n);
        for (var r = !E(t) && y.keys(t), i = (r || t).length, s = Array(i), o = 0; i > o; o++) {
            var a = r ? r[o] : o;
            s[o] = e(t[a], a, t)
        }
        return s
        ...
        var r;
        return r = E(t) ? y.findIndex(t, e, n) : y.findKey(t, e, n), void 0 !== r && -1 !== r ? t[r] : void 0
        ...
        e = b(e, n);
        for (var r = !E(t) && y.keys(t), i = (r || t).length, s = 0; i > s; s++) {
            var o = r ? r[s] : s;
        ...
        return E(t) || (t = y.values(t)), ("number" != typeof n || r) && (n = 0), y.indexOf(t, e, n) >= 0
    }, y.invoke = function (t, e) {
        var n = l.call(arguments, 2), r = y.isFunction(e);
        ...
        if (null == e && null != t) {
            t = E(t) ? t : y.values(t);
            for (var a = 0, c = t.length; c > a; a++)r = t[a], r > s && (s = r)
        ...
        if (null == e && null != t) {
            t = E(t) ? t : y.values(t);
            for (var a = 0, c = t.length; c > a; a++)r = t[a], s > r && (s = r)
        } else e = b(e, n), y.each(t, function (t, n, r) {
            i = e(t, n, r), (o > i || i === 1 / 0 && s === 1 / 0) && (s = t, o = i)
        });
        return s
    }, y.shuffle = function (t) {
        for (var e, n = E(t) ? t : y.values(t), r = n.length, i = Array(r), s = 0; r > s; s++)e = y.random(0, s), e !== s && (i[s] = i[e]), i[e] = n[s];
        return i
    ...
    var j = function (t) {
        return function (e, n, r) {
            var i = {};
            return n = b(n, r), y.each(e, function (r, s) {
                var o = n(r, s, e);
                t(i, r, o)
            }), i
        }
    ...
    y.groupBy = j(function (t, e, n) {
        ...
        return t ? y.isArray(t) ? l.call(t) : E(t) ? y.map(t, y.identity) : y.values(t) : []
    }, y.size = function (t) {
    ...
    var A = function (t, e, n, r) {
        for (var i = [], s = 0, o = r || 0, a = k(t); a > o; o++) {
            var c = t[o];
            if (E(c) && (y.isArray(c) || y.isArguments(c))) {
                e || (c = A(c, e, n));
                var u = 0, l = c.length;
                for (i.length += l; l > u;)i[s++] = c[u++]
            } else n || (i[s++] = c)
        }
        return i
    };
    y.flatten = function (t, e) {
        ...
        for (var i = [], s = [], o = 0, a = k(t); a > o; o++) {
            var c = t[o], u = n ? n(c, o, t) : c;
            e ? (o && s === u || i.push(c), s = u) : n ? y.contains(s, u) || (s.push(u), i.push(c)) : y.contains(i, c) || i.push(c)
        }
        return i
    }, y.union = function () {
        return y.uniq(A(arguments, !0, !0))
    }, y.intersection = function (t) {
        for (var e = [], n = arguments.length, r = 0, i = k(t); i > r; r++) {
            var s = t[r];
            if (!y.contains(e, s)) {
        ...
        for (var e = t && y.max(t, k).length || 0, n = Array(e), r = 0; e > r; r++)n[r] = y.pluck(t, r);
        return n
    }, y.object = function (t, e) {
        for (var n = {}, r = 0, i = k(t); i > r; r++)e ? n[t[r]] = e[r] : n[t[r][0]] = t[r][1];
        return n
    }, y.findIndex = e(1), y.findLastIndex = e(-1), y.sortedIndex = function (t, e, n, r) {
        n = b(n, r, 1);
        for (var i = n(e), s = 0, o = k(t); o > s;) {
    ...
    var I = function (t, e, n, r, i) {
        ...
        var s = w(t.prototype), o = t.apply(s, i);
    ...
    y.bind = function (t, e) {
        ...
        var e = l.call(arguments, 1), n = function () {
            for (var r = 0, i = e.length, s = Array(i), o = 0; i > o; o++)s[o] = e[o] === y ? arguments[r++] : e[o];
        ...
        var n = function (r) {
            ...
            return y.has(i, s) || (i[s] = t.apply(this, arguments)), i[s]
        };
        return n.cache = {}, n
        ...
        n || (n = {});
        var c = function () {
            a = n.leading === !1 ? 0 : y.now(), o = null, s = t.apply(r, i), o || (r = i = null)
        };
        return function () {
            var u = y.now();
            a || n.leading !== !1 || (a = u);
            var l = e - (u - a);
            return r = this, i = arguments, 0 >= l || l > e ? (o && (clearTimeout(o), o = null), a = u, s = t.apply(r, i), o || (r = i = null)) : o || n.trailing === !1 || (o = setTimeout(c, l)), s
        }
    }, y.debounce = function (t, e, n) {
        var r, i, s, o, a, c = function () {
            var u = y.now() - o;
            e > u && u >= 0 ? r = setTimeout(c, e - u) : (r = null, n || (a = t.apply(s, i), r || (s = i = null)))
        };
        return function () {
    ...
    var $ = !{toString: null}.propertyIsEnumerable("toString"), F = ["valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString"];
    y.keys = function (t) {
        if (!y.isObject(t))return [];
        if (p)return p(t);
        var e = [];
        ...
        e = b(e, n);
        for (var r, i = y.keys(t), s = i.length, o = {}, a = 0; s > a; a++)r = i[a], o[r] = e(t[r], r, t);
        return o
    }, y.pairs = function (t) {
        ...
        e = b(e, n);
        for (var r, i = y.keys(t), s = 0, o = i.length; o > s; s++)if (r = i[s], e(t[r], r, t))return r
    }, y.pick = function (t, e, n) {
        var r, i, s = {}, o = t;
        if (null == o)return s;
        y.isFunction(e) ? (i = y.allKeys(o), r = _(e, n)) : (i = A(arguments, !1, !1, 1), r = function (t, e, n) {
            return e in n
        }, o = Object(o));
    ...
    var O = function (t, e, n, r) {
        ...
        if (n.push(t), r.push(e), s) {
            ...
            for (; c--;)if (!O(t[c], e[c], n, r))return !1
        } else {
            var u, l = y.keys(t);
            if (c = l.length, y.keys(e).length !== c)return !1;
            for (; c--;)if (u = l[c], !y.has(e, u) || !O(t[u], e[u], n, r))return !1
        }
    ...
    }, y.property = C, y.propertyOf = function (t) {
    ...
    var T = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;"}, M = y.invert(T), R = function (t) {
        var e = function (e) {
            return t[e]
        }, n = "(?:" + y.keys(t).join("|") + ")", r = RegExp(n), i = RegExp(n, "g");
        return function (t) {
            return t = null == t ? "" : "" + t, r.test(t) ? t.replace(i, e) : t
        }
    };
    y.escape = R(T), y.unescape = R(M), y.result = function (t, e, n) {
    ...
    y.template = function (t, e, n) {
        ...
        var r = RegExp([(e.escape || N).source, (e.interpolate || N).source, (e.evaluate || N).source].join("|") + "|$", "g"), i = 0, s = "__p+='";
        t.replace(r, function (e, n, r, o, a) {
            return s += t.slice(i, a).replace(H, q), i = a + e.length, n ? s += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? s += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : o && (s += "';\n" + o + "\n__p+='"), e
    ...
    y.mixin = function (t) {
        y.each(y.functions(t), function (e) {
            ...
            y.prototype[e] = function () {
                var t = [this._wrapped];
                return u.apply(t, arguments), L(this, n.apply(y, t))
            }
        })
    ...
    if ("function" == typeof define && define.amd)define(["../../../../public/js/lib/underscore", "jquery", "exports"], function (n, r, i) {
    ...
    }, c = e.Events = {}, u = /\s+/, l = function (t, e, r, i, s) {
        var o, a = 0;
        if (r && "object" == typeof r) {
            void 0 !== i && "context"in s && void 0 === s.context && (s.context = i);
            for (o = n.keys(r); a < o.length; a++)e = t(e, o[a], r[o[a]], s)
        } else if (r && u.test(r))for (o = r.split(u); a < o.length; a++)e = t(e, o[a], i, s); else e = t(e, r, i, s);
        return e
    };
    c.on = function (t, e, n) {
        return h(this, t, e, n)
    ...
    var h = function (t, e, n, r, i) {
        if (t._events = l(f, t._events || {}, e, n, {context: r, ctx: t, listening: i}), i) {
    ...
    c.listenTo = function (t, e, r) {
        if (!t)return this;
        var i = t._listenId || (t._listenId = n.uniqueId("l")), s = this._listeningTo || (this._listeningTo = {}), o = s[i];
        if (!o) {
            var a = this._listenId || (this._listenId = n.uniqueId("l"));
            o = s[i] = {obj: t, objId: i, id: a, listeningTo: s, count: 0}
        }
        return h(t, e, r, this, o), this
    };
    var f = function (t, e, n, r) {
        if (n) {
            var i = t[e] || (t[e] = []), s = r.context, o = r.ctx, a = r.listening;
            a && a.count++, i.push({callback: n, context: s, ctx: s || o, listening: a})
        }
        return t
    };
    c.off = function (t, e, n) {
        return this._events ? (this._events = l(d, this._events, t, e, {context: n, listeners: this._listeners}), this) : this
    ...
    var d = function (t, e, r, i) {
        if (t) {
            var s, o = 0, a = i.context, c = i.listeners;
            if (e || r || a) {
                for (var u = e ? [e] : n.keys(t); o < u.length; o++) {
                    e = u[o];
                    var l = t[e];
                    if (!l)break;
                    for (var h = [], f = 0; f < l.length; f++) {
                        var d = l[f];
                        r && r !== d.callback && r !== d.callback._callback || a && a !== d.context ? h.push(d) : (s = d.listening, s && 0 === --s.count && (delete c[s.id], delete s.listeningTo[s.objId]))
                    }
                    h.length ? t[e] = h : delete t[e]
                }
                return n.size(t) ? t : void 0
            }
            for (var p = n.keys(c); o < p.length; o++)s = c[p[o]], delete c[s.id], delete s.listeningTo[s.objId]
        }
    };
    c.once = function (t, e, r) {
        var i = l(p, {}, t, e, n.bind(this.off, this));
        return this.on(i, void 0, r)
    }, c.listenToOnce = function (t, e, r) {
        var i = l(p, {}, e, r, n.bind(this.stopListening, this, t));
    ...
    c.trigger = function (t) {
        ...
        return l(g, this._events, t, void 0, n), this
    };
    ...
    n.extend(m.prototype, c, {
        changed: null, validationError: null, idAttribute: "id", cidPrefix: "c", initialize: function () {
            ...
            var s = r.unset, o = r.silent, a = [], c = this._changing;
            ...
            for (var f in i)e = i[f], n.isEqual(u[f], e) || a.push(f), n.isEqual(h[f], e) ? delete l[f] : l[f] = e, s ? delete u[f] : u[f] = e;
            if (!o) {
                a.length && (this._pending = r);
                for (var d = 0; d < a.length; d++)this.trigger("change:" + a[d], this, u[a[d]], r)
            }
            if (c)return this;
            ...
            var e = this._changing ? this._previousAttributes : this.attributes, r = {};
            for (var i in t) {
                var s = t[i];
            ...
            t = t ? n.clone(t) : {};
            var e = this, r = t.success, i = t.wait, s = function () {
            ...
            var o = !1;
            return this.isNew() ? n.defer(t.success) : (H(this, t), o = this.sync("delete", this, t)), i || s(), o
        }, url: function () {
            ...
            return r ? (this.trigger("invalid", this, r, n.extend(e, {validationError: r})), !1) : !0
        }
    });
    ...
    n.extend(_.prototype, c, {
        model: m, initialize: function () {
            ...
            var r = !n.isArray(t);
            t = r ? t ? [t] : [] : t.slice();
            var i, s, o, a, c, u = e.at;
            null != u && (u = +u), 0 > u && (u += this.length + 1);
            for (var l = this.comparator && null == u && e.sort !== !1, h = n.isString(this.comparator) ? this.comparator : null, f = [], d = [], p = {}, g = e.add, v = e.merge, m = e.remove, y = !l && g && m ? [] : !1, _ = !1, x = 0; x < t.length; x++) {
                if (o = t[x], a = this.get(o))m && (p[a.cid] = !0), v && o !== a && (o = this._isModel(o) ? o.attributes : o, e.parse && (o = a.parse(o, e)), a.set(o, e), l && !c && a.hasChanged(h) && (c = !0)), t[x] = a; else if (g) {
                    if (s = t[x] = this._prepareModel(o, e), !s)continue;
                    f.push(s), this._addReference(s, e)
                }
                s = a || s, s && (i = this.modelId(s.attributes), !y || !s.isNew() && p[i] || (y.push(s), _ = _ || !this.models[x] || s.cid !== this.models[x].cid), p[i] = !0)
            }
            if (m) {
                for (var x = 0; x < this.length; x++)p[(s = this.models[x]).cid] || d.push(s);
                d.length && this._removeModels(d, e)
            }
            if (f.length || _)if (l && (c = !0), this.length += f.length, null != u)for (var x = 0; x < f.length; x++)this.models.splice(u + x, 0, f[x]); else {
                y && (this.models.length = 0);
                for (var w = y || f, x = 0; x < w.length; x++)this.models.push(w[x])
            }
            if (c && this.sort({silent: !0}), !e.silent) {
                for (var C = null != u ? n.clone(e) : e, x = 0; x < f.length; x++)null != u && (C.index = u + x), (s = f[x]).trigger("add", s, this, C);
                (c || _) && this.trigger("sort", this, e), (f.length || d.length) && this.trigger("update", this, e)
            }
            return r ? t[0] : t
        }, reset: function (t, e) {
            e = e ? n.clone(e) : {};
            ...
            if ("add" !== t && "remove" !== t || n === this) {
                if ("destroy" === t && this.remove(e, r), "change" === t) {
                    var i = this.modelId(e.previousAttributes()), s = this.modelId(e.attributes);
    ...
    n.each(C, function (t) {
        n[t] && (_.prototype[t] = function (e, r) {
    ...
    n.extend(S.prototype, c, {
        ...
        if (i.url || (o.url = n.result(r, "url") || B()), null != i.data || !r || "create" !== t && "update" !== t && "patch" !== t || (o.contentType = "application/json", o.data = JSON.stringify(i.attrs || r.toJSON(i))), i.emulateJSON && (o.contentType = "application/x-www-form-urlencoded", o.data = o.data ? {model: o.data} : {}), i.emulateHTTP && ("PUT" === s || "DELETE" === s || "PATCH" === s)) {
    ...
    n.extend(A.prototype, c, {
        initialize: function () {
            ...
            return t = t.replace(O, "\\$&").replace(I, "(?:$1)?").replace($, function (t, e) {
                return e ? t : "([^/?]+)"
    ...
    T.started = !1, n.extend(T.prototype, c, {
        interval: 50, atRoot: function () {
            ...
            if (T.started = !0, this.options = n.extend({root: "/"}, this.options, t), this.root = this.options.root, this._wantsHashChange = this.options.hashChange !== !1, this._hasHashChange = "onhashchange"in window, this._useHashChange = this._wantsHashChange && this._hasHashChange, this._wantsPushState = !!this.options.pushState, this._hasPushState = !(!this.history || !this.history.pushState), this._usePushState = this._wantsPushState && this._hasPushState, this.fragment = this.getFragment(), this.root = ("/" + this.root + "/").replace(R, "/"), this._wantsHashChange && this._wantsPushState) {
            ...
            this._usePushState ? t("popstate", this.checkUrl, !1) : this._useHashChange && !this.iframe && t("hashchange", this.checkUrl, !1), this.iframe && (document.body.removeChild(this.iframe), this.iframe = null), this._checkUrlInterval && clearInterval(this._checkUrlInterval), T.started = !1
        }, route: function (t, e) {
            ...
            if (t = this.decodeFragment(t.replace(P, "")), this.fragment !== t) {
                if (this.fragment = t, this._usePushState)this.history[e.replace ? "replaceState" : "pushState"]({}, document.title, r); else {
    ...
    m.extend = _.extend = A.extend = S.extend = T.extend = N;
    var B = function () {
    ...
    "function" == typeof define && define.amd ? define(["underscore", "backbone", "../../../../public/js/lib/jquery"], function (n, r, i) {
        return t.Backbone = e(n, r, i)
    }) : "undefined" != typeof exports && "undefined" != typeof require ? module.exports = e(require("underscore"), require("backbone"), require("jquery")) : t.Backbone = e(t._, t.Backbone, t.jQuery)
}(this, function (t, e, n) {
    function r(e, r) {
        if (e && t.isObject(e)) {
            if (t.isFunction(e.getCacheKey))return e.getCacheKey(r);
            e = r && r.url ? r.url : t.isFunction(e.url) ? e.url() : e.url
        } else if (t.isFunction(e))return e(r);
        return r && r.data ? "string" == typeof r.data ? e + "?" + r.data : e + "?" + n.param(r.data) : e
    }

    function i(t, n, r) {
        n = n || {};
        var i = e.fetchCache.getCacheKey(t, n), s = !1, o = n.lastSync || (new Date).getTime(), a = !1;
        i && n.cache !== !1 && (n.cache || n.prefill) && (n.expires !== !1 && (s = (new Date).getTime() + 1e3 * (n.expires || 300)), n.prefillExpires !== !1 && (a = (new Date).getTime() + 1e3 * (n.prefillExpires || 300)), e.fetchCache._cache[i] = {
            expires: s,
            lastSync: o,
            prefillExpires: a,
            value: r
        }, e.fetchCache.setLocalStorage())
    }

    function s(n, i) {
        return t.isFunction(n) ? n = n() : n && t.isObject(n) && (n = r(n, i)), e.fetchCache._cache[n]
    }
    ...
    function a(n, i) {
        t.isFunction(n) ? n = n() : n && t.isObject(n) && (n = r(n, i)), delete e.fetchCache._cache[n], e.fetchCache.setLocalStorage()
    }

    function c() {
        if (f && e.fetchCache.localStorage)try {
            localStorage.setItem(e.fetchCache.getLocalStorageKey(), JSON.stringify(e.fetchCache._cache))
        } catch (t) {
            var n = t.code || t.number || t.message;
            if (22 !== n && 1014 !== n)throw t;
            this._deleteCacheWithPriority()
        }
    }

    function u() {
        if (f && e.fetchCache.localStorage) {
            var t = localStorage.getItem(e.fetchCache.getLocalStorageKey()) || "{}";
            e.fetchCache._cache = JSON.parse(t)
        }
    }
    ...
    var h = {modelFetch: e.Model.prototype.fetch, modelSync: e.Model.prototype.sync, collectionFetch: e.Collection.prototype.fetch}, f = function () {
        var t = "undefined" != typeof window.localStorage;
        if (t)try {
    ...
    return e.fetchCache = e.fetchCache || {}, e.fetchCache._cache = e.fetchCache._cache || {}, e.fetchCache.enabled = !0, e.fetchCache.priorityFn = function (t, e) {
        return t && t.expires && e && e.expires ? t.expires - e.expires : t
    }, e.fetchCache._prioritize = function () {
        var e = t.values(this._cache).sort(this.priorityFn), n = t.indexOf(t.values(this._cache), e[0]);
        return t.keys(this._cache)[n]
    }, e.fetchCache._deleteCacheWithPriority = function () {
        e.fetchCache._cache[this._prioritize()] = null, delete e.fetchCache._cache[this._prioritize()], e.fetchCache.setLocalStorage()
    }, e.fetchCache.getLocalStorageKey = function () {
        return "backboneCache"
    }, "undefined" == typeof e.fetchCache.localStorage && (e.fetchCache.localStorage = !0), e.Model.prototype.fetch = function (r) {
        function i() {
            return r.prefill && (!r.prefillExpires || f)
        }

        function o() {
            r.parse && (d = g.parse(d, r)), g.set(d, r), t.isFunction(r.prefillSuccess) && r.prefillSuccess(g, d, r), g.trigger("cachesync", g, d, r), g.trigger("sync", g, d, r), i() ? p.notify(g) : (t.isFunction(r.success) && r.success(g, d, r), p.resolve(g))
        }

        if (!e.fetchCache.enabled)return h.modelFetch.apply(this, arguments);
        r = t.defaults(r || {}, {parse: !0});
        var a = e.fetchCache.getCacheKey(this, r), c = s(a), u = !1, f = !1, d = !1, p = new n.Deferred, g = this;
        if (c && (u = c.expires, u = u && c.expires < (new Date).getTime(), f = c.prefillExpires, f = f && c.prefillExpires < (new Date).getTime(), d = c.value), !u && (r.cache || r.prefill) && d && (null == r.async && (r.async = !0), r.async ? l(o) : o(), !i()))return p;
        var v = h.modelFetch.apply(this, arguments);
        return v.done(t.bind(p.resolve, this, this)).done(t.bind(e.fetchCache.setCache, null, this, r)).fail(t.bind(p.reject, this, this)), p.abort = v.abort, p
    }, e.Model.prototype.sync = function (t, n, r) {
        if ("read" === t || !e.fetchCache.enabled)return h.modelSync.apply(this, arguments);
        var i, s, o = n.collection, c = [];
        for (c.push(e.fetchCache.getCacheKey(n, r)), o && c.push(e.fetchCache.getCacheKey(o)), i = 0, s = c.length; s > i; i++)a(c[i]);
        return h.modelSync.apply(this, arguments)
    }, e.Collection.prototype.fetch = function (r) {
        function i() {
            return r.prefill && (!r.prefillExpires || f)
        }

        function o() {
            g[r.reset ? "reset" : "set"](d, r), t.isFunction(r.prefillSuccess) && r.prefillSuccess(g), g.trigger("cachesync", g, d, r), g.trigger("sync", g, d, r), i() ? p.notify(g) : (t.isFunction(r.success) && r.success(g, d, r), p.resolve(g))
        }

        if (!e.fetchCache.enabled)return h.collectionFetch.apply(this, arguments);
        r = t.defaults(r || {}, {parse: !0});
        var a = e.fetchCache.getCacheKey(this, r), c = s(a), u = !1, f = !1, d = !1, p = new n.Deferred, g = this;
        if (c && (u = c.expires, u = u && c.expires < (new Date).getTime(), f = c.prefillExpires, f = f && c.prefillExpires < (new Date).getTime(), d = c.value), !u && (r.cache || r.prefill) && d && (null == r.async && (r.async = !0), r.async ? l(o) : o(), !i()))return p;
        var v = h.collectionFetch.apply(this, arguments);
        return v.done(t.bind(p.resolve, this, this)).done(t.bind(e.fetchCache.setCache, null, this, r)).fail(t.bind(p.reject, this, this)), p.abort = v.abort, p
    }, u(), e.fetchCache._superMethods = h, e.fetchCache.setCache = i, e.fetchCache.getCache = s, e.fetchCache.getCacheKey = r, e.fetchCache.getLastSync = o, e.fetchCache.clearItem = a, e.fetchCache.setLocalStorage = c, e.fetchCache.getLocalStorage = u, e
}), $.ajaxSetup({cache: !0});
var CountryModel = Backbone.Model.extend(), FilterCountryCollection = Backbone.Collection.extend({
    model: CountryModel, initialize: function () {
        this.sortField = "name", this.sortDirection = "ASC"
    }, setSortField: function (t, e) {
        this.sortField = t, this.sortDirection = e
    }, comparator: function (t) {
        return t.get(this.sortField)
    }, sortBy: function (t, e) {
        var n = this.models, r = this.sortDirection;
        return _.pluck(_.map(n, function (n, r, i) {
            return {value: n, index: r, criteria: t.call(e, n, r, i)}
        }).sort(function (t, e) {
            var n = "ASC" === r ? t.criteria : e.criteria, i = "ASC" === r ? e.criteria : t.criteria;
            if (n !== i) {
    ...
    initialize: function (t) {
        this.url = t
    }, model: CountryModel, url: this.url, search: function (t) {
        var e = "name", n = "code";
        if ("undefined" == typeof t || "" == t)return this;
        var r = new RegExp(t, "gi");
        return _(this.filter(function (t) {
            return r.test(t.get(e)) || r.test(t.get(n))
        }))
    }, countries: function (t, e) {
        var n;
        n = this.search(t), n = new FilterCountryCollection(n.toArray()), "undefined" != typeof e && (n.setSortField("name", e.toUpperCase()), n.sort());
        var r = [];
        return _.each(n.models, function (t) {
            r.push({code: t.get("code"), name: t.get("name"), contract: t.get("contract")})
        }), r
    }
    ...
    initialize: function () {
        ...
        return this.el = this.template(this.model), this
    }
}), CountryList = Backbone.View.extend({
    initialize: function (t) {
        this.query = t.query, this.sort_type = t.sort_type, this.collection.on("sort", this.sort, this), this.collection.on("search", this.search, this), this.collection.on("reset", this.render, this)
    }, search: function (t) {
        this.query = t, this.render()
    }, sort: function (t) {
        this.sort_type = t, this.render()
    }, render: function () {
        var t = this, e = this.collection.countries(this.query, this.sort_type, this.resources);
        return $(t.el).html(""), _.each(e, function (e) {
            $(t.el).append(new CountryView({model: e}).render().el)
        }), this
    }
}), ResourceModel = Backbone.Model.extend(), ResourceController = Backbone.Collection.extend({
    initialize: function (t) {
        this.url = t
    }, model: ResourceModel, url: this.url, resources: function () {
        var t = [];
        return this.each(function (e) {
            t.push({name: e.get("resource"), value: e.get("resource"), contract: e.get("contract")})
        }), t
    }
...
}), ResourceList = Backbone.View.extend({
    initialize: function () {
        this.collection.on("reset", this.render, this)
    }, render: function () {
        var t = this, e = this.collection.resources();
        return $(t.el).html(""), _.each(e, function (e) {
            $(t.el).append(new ResourceView({model: e}).render().el)
        }), this
    }
}), collection = new CountryCollection(APP_URL + "/contract/countries");
collection.fetch({reset: !0, cache: !0, expires: 6e4});
var countryList = new CountryList({el: "#countries", sort_type: "asc", collection: collection}).el, rCollection = new ResourceController(APP_URL + "/contract/resources");
rCollection.fetch({reset: !0, cache: !0, expires: 6e4});
var resourceList = new ResourceList({el: "#resources", collection: rCollection});
$(function () {
    $(document).on("click", ".resource", function () {
        var t = [];
        $(".resource:checked").each(function () {
            t.push($(this).val())
        }), collection.url = APP_URL + "/contract/countries?resource=" + t.join(), collection.fetch({
            reset: !0, cache: !0, expires: 6e4, success: function () {
                $("#countries").find(".col-lg-2").removeClass("col-lg-2").addClass("col-lg-3"), $(".side-collapse").css("height", $("#countries").height() + 150 + "px"), $(window).width() < 1200 && $("#countries").find(".col-md-3,.col-md-6").toggleClass("col-md-3").toggleClass("col-md-6"), $(window).width() < 992 && $("#countries").find(".col-sm-4,.col-sm-6").toggleClass("col-sm-4").toggleClass("col-sm-6"), $(window).width() < 768 && $("#countries").find(".col-xs-6,.col-xs-12").toggleClass("col-xs-6").toggleClass("col-xs-12")
            }
        })
    }), $(document).on("change", ".sort", function (t) {
        t.preventDefault(), collection.trigger("sort", $(this).val())
    }), $(document).on("input", ".search", function (t) {
        t.preventDefault(), collection.trigger("search", $(this).val())
    })
});