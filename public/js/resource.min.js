(function () {
    ...
    function r(t, e) {
        var n = O.length, r = t.constructor, i = y.isFunction(r) && r.prototype || a, s = "constructor";
        for (y.has(t, s) && !y.contains(e, s) && e.push(s); n--;)s = O[n], s in t && t[s] !== i[s] && !y.contains(e, s) && e.push(s)
    }
    ...
    var F = !{toString: null}.propertyIsEnumerable("toString"), O = ["valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString"];
    y.keys = function (t) {
        if (!y.isObject(t))return [];
        if (p)return p(t);
        var e = [];
    ...
    var T = function (t, e, n, r) {
        ...
        if (n.push(t), r.push(e), s) {
            ...
            for (; c--;)if (!T(t[c], e[c], n, r))return !1
        } else {
            var u, l = y.keys(t);
            if (c = l.length, y.keys(e).length !== c)return !1;
            for (; c--;)if (u = l[c], !y.has(e, u) || !T(t[u], e[u], n, r))return !1
        }
    ...
    y.escape = M($), y.unescape = M(R), y.result = function (t, e, n) {
    ...
    n.extend(A.prototype, c, {
        initialize: function () {
            ...
            return t = t.replace(T, "\\$&").replace(I, "(?:$1)?").replace(F, function (t, e) {
                return e ? t : "([^/?]+)"
    ...
    $.started = !1, n.extend($.prototype, c, {
    ...
    m.extend = _.extend = A.extend = S.extend = $.extend = N;
    var B = function () {
...
var ResourceModel = Backbone.Model.extend(), FilterCollection = Backbone.Collection.extend({
    model: ResourceModel, initialize: function () {
    ...
    initialize: function (t) {
        this.url = t
    }, model: ResourceModel, url: this.url, search: function (t) {
        var e = "resource";
        if ("undefined" == typeof t || "" == t)return this;
        var n = new RegExp(t, "gi");
        return _(this.filter(function (t) {
            return n.test(t.get(e))
        }))
    }, resources: function (t, e) {
        var n;
        n = this.search(t), n = new FilterCollection(n.toArray()), "undefined" != typeof e && (n.setSortField("resource", e.toUpperCase()), n.sort());
        var r = [];
        return _.each(n.models, function (t) {
            r.push({value: encodeURIComponent(t.get("resource")), name: t.get("resource"), contract: t.get("contract")})
        }), r
    }
    ...
    initialize: function (t) {
        ...
        var t = this, e = this.collection.resources(this.query, this.sort_type, this.resources);
        return $(t.el).html(""), _.each(e, function (e) {
            $(t.el).append(new ResourceView({model: e}).render().el)
        }), this
    }
}), CountryModel = Backbone.Model.extend(), CountryController = Backbone.Collection.extend({
    initialize: function (t) {
        this.url = t
    }, model: CountryModel, url: this.url, resources: function () {
        var t = [];
        return this.each(function (e) {
            t.push({code: e.get("code"), name: e.get("name"), contract: e.get("contract")})
        }), t
    }
...
}), collection = new ResourceCollection(APP_URL + "/contract/resources");
collection.fetch({reset: !0, cache: !0, expires: 6e4});
var resourceList = new ResourceList({el: "#resources", sort_type: "asc", collection: collection}).el, rCollection = new CountryController(APP_URL + "/contract/countries");
rCollection.fetch({reset: !0, cache: !0, expires: 6e4});
var countryList = new CountryList({el: "#countries", collection: rCollection});
$(function () {
    $(document).on("click", ".country", function () {
        var t = [];
        $(".country:checked").each(function () {
            t.push($(this).val())
        }), collection.url = APP_URL + "/contract/resources?country=" + t.join(), collection.fetch({
            reset: !0, cache: !0, expires: 6e4, success: function () {
                $("#resources").find(".col-lg-4").removeClass("col-lg-4").addClass("col-lg-6"), $(".side-collapse").css("height", $("#resources").height() + 150 + "px")
            }
        })
