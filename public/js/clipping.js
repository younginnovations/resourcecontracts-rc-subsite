...
Backbone.Paginator=function(a,b,c){"use strict";var d={};return d.version="0.15",d.clientPager=a.Collection.extend({sync:function(a,d,e){var f={};f[this.perPageAttribute]=this.perPage,f[this.skipAttribute]=this.page*this.perPage,f[this.orderAttribute]=this.sortField,f[this.customAttribute1]=this.customParam1,f[this.formatAttribute]=this.format,f[this.customAttribute2]=this.customParam2,f[this.queryAttribute]=this.query;var g=b.extend({type:"GET",dataType:"jsonp",jsonpCallback:"callback",data:decodeURIComponent(c.param(f)),url:this.url,processData:!1},e);return c.ajax(g)},nextPage:function(){this.page=++this.page,this.pager()},previousPage:function(){this.page=--this.page||1,this.pager()},goTo:function(a){a!==undefined&&(this.page=parseInt(a,10),this.pager())},howManyPer:function(a){a!==undefined&&(this.displayPerPage=parseInt(a,10),this.pager())},setSort:function(a,b){a!==undefined&&b!==undefined&&this.pager(a,b)},pager:function(a,b){var c=this,d=this.displayPerPage,e=(c.page-1)*d,f=e+d;c.origModels===undefined&&(c.origModels=c.models),c.models=c.origModels,a&&(c.models=c._sort(c.models,a,b)),c.reset(c.models.slice(e,f))},_sort:function(a,b,c){return a=a.sort(function(a,d){var e=a.get(b),f=d.get(b);if(c==="desc"){if(e>f)return-1;if(e<f)return 1}else{if(e<f)return-1;if(e>f)return 1}return 0}),a},info:function(){var a=this,b={},c=a.origModels?a.origModels.length:a.length,d=Math.ceil(c/a.displayPerPage);return b={totalRecords:c,page:a.page,perPage:this.displayPerPage,totalPages:d,lastPage:d,lastPagem1:d-1,previous:!1,next:!1,page_set:[],startRecord:(a.page-1)*this.displayPerPage+1,endRecord:Math.min(c,a.page*this.displayPerPage)},a.page>1&&(b.prev=a.page-1),a.page<b.totalPages&&(b.next=a.page+1),b.pageSet=a.setPagination(b),a.information=b,b},setPagination:function(a){var b=[],c=0,d=0,e=3,f=e*2,g=Math.ceil(a.totalRecords/a.perPage),h=-1;if(g>1)if(g<7+f)for(c=1,d=g;c<=d;c++)b.push(c);else if(g>5+f)if(a.page<1+f)for(c=1,d=4+f;c<d;c++)b.push(c);else if(g-f>a.page&&a.page>f)for(c=a.page-e;c<=a.page+e;c++)b.push(c);else for(c=g-(2+f);c<=g;c++)b.push(c);return b}}),d.requestPager=a.Collection.extend({sync:function(a,d,e){var f={},g;return f[this.perPageAttribute]=this.perPage,f[this.skipAttribute]=this.page*this.perPage,f[this.orderAttribute]=this.sortField,f[this.customAttribute1]=this.customParam1,f[this.formatAttribute]=this.format,f[this.customAttribute2]=this.customParam2,f[this.queryAttribute]=this.query,g=b.extend({type:"GET",dataType:"jsonp",jsonpCallback:"callback",data:decodeURIComponent(c.param(f)),url:this.url,processData:!1},e),c.ajax(g)},requestNextPage:function(){this.page!==undefined&&(this.page+=1,this.pager())},requestPreviousPage:function(){this.page!==undefined&&(this.page-=1,this.pager())},updateOrder:function(a){a!==undefined&&(this.sortField=a,this.pager())},goTo:function(a){a!==undefined&&(this.page=parseInt(a,10),this.pager())},howManyPer:function(a){a!==undefined&&(this.page=this.firstPage,this.perPage=a,this.pager())},sort:function(){},info:function(){var a={page:this.page,firstPage:this.firstPage,totalPages:this.totalPages,lastPage:this.totalPages,perPage:this.perPage};return this.information=a,a},pager:function(){this.fetch({})}}),d}(Backbone,_,$)
...
var Filter = React.createClass({displayName: "Filter",
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "row clip-search-row"}, 
                React.createElement("div", {className: "col-md-2"}, 
                    React.createElement("label", null, "langClip.year"), 
                    React.createElement(Option, {multiple: true, name: "year", clipCollection: this.props.clipCollection, options: filter.year})
                ), 
                React.createElement("div", {className: "col-md-2"}, 
                    React.createElement("label", null, "langClip.country"), 
                    React.createElement(Option, {multiple: true, name: "country", clipCollection: this.props.clipCollection, options: filter.country})
                ), 
                React.createElement("div", {className: "col-md-2"}, 
                    React.createElement("label", null, "langClip.resource"), 
                    React.createElement(Option, {multiple: true, name: "resource", clipCollection: this.props.clipCollection, options: filter.resource})
                ), 
                React.createElement("div", {className: "col-md-2"}, 
                    React.createElement("label", null, "langClip.category"), 
                    React.createElement(Option, {multiple: true, name: "category", clipCollection: this.props.clipCollection, options: filter.category})
                )
            )
        );
    }
...
var Option = React.createClass({displayName: "Option",
    ...
    render: function () {
        ...
        return (
            React.createElement("select", {className: this.getClass(), dangerouslySetInnerHTML: {__html: options}, multiple: this.props.multiple, name: this.props.name})
        );
    }
});

var ClipSelectCount = React.createClass({displayName: "ClipSelectCount",
    getInitialState: function () {
        return {
            count: 0
        }
...
var DownloadManager = React.createClass({displayName: "DownloadManager",
    getInitialState: function () {
        return {
            clips: [],
            dropdown: false,
    ...
    render: function () {
        ...
        if (this.state.loadingPdf) {
            download_pdf = (React.createElement("div", {className: "pdf-download-processing"}, 
                React.createElement("nobr", null, langClip.pdfClip), 
                React.createElement("small", null, langClip.processing)
            ));
        } else {
            download_pdf = (React.createElement("a", {id: "pdf-zip-download", onClick: this.handleZipDownload}, langClip.pdfClip));
        }
            ...
            React.createElement("div", {className: "actions-wrapper action-btn"}, 
                ...
                React.createElement("div", {className: "download-dropdown"}, 
                    ...
                    React.createElement("ul", {style: style, className: "dropdown-menu"}, 
                        ...
                        React.createElement("li", null, download_pdf)
                    )
                ), 
                ...
                React.createElement("div", {className: "modal-social-share-wrap social-share"}, 
                    React.createElement("div", null, 
                        React.createElement("div", {id: "save-clipping", style: {width:'135px'}, 
                             onClick: this.handleSave}, this.state.loading ? langClip.saving : langClip.save_and_shareClip), 
...
var ShareManager = React.createClass({displayName: "ShareManager",
    getInitialState: function () {
        return {
            dropdown: false,
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "clipShare"}, 
                React.createElement("ul", {className: "social-toggle", style: style}, 
                    React.createElement("li", {className: "facebook"}, React.createElement("a", {href:  this.getFacebookShare(), target: "_blank"})), 
                    React.createElement("li", {className: "twitter"}, React.createElement("a", {href:  this.getTwitterShare(), target: "_blank"})), 
                    React.createElement("li", {className: "email"}, React.createElement("a", {onClick: this.handleShowModal}))
                ), 
...
var Email = React.createClass({displayName: "Email",
    ...
    setError: function (key, err) {
        ...
        errors.push({key: key, error: (React.createElement("span", {className: "required"}, err))});
                    ...
                    React.createElement("div", {className: "modal-content"}, 
                        React.createElement("div", {className: "modal-header"}, 
                            React.createElement("button", {type: "button", className: "close", "data-dismiss": "modal", "aria-label": "Close"}, React.createElement("span", {
                                "aria-hidden": "true"}, "×")), 
                            React.createElement("h4", {className: "modal-title"}, langClip.shareViaEmail)
                        ), 
                        React.createElement("div", {className: "modal-body"}, 
                            React.createElement("div", {className: "email-result"}), 
                            React.createElement("form", {onSubmit: this.handleSubmit}, 
                                React.createElement("div", {className: "form-group"}, 
                                    React.createElement("label", {for: "to"}, langClip.to), 
                                    React.createElement("input", {id: "to", type: "text", 
                                           onChange: function(e) {self.setState({to:e.target.value})}, 
                                           value: this.state.to, className: "form-control"}), 
                                    this.getError('to')
                                ), 
                                React.createElement("div", {className: "form-group"}, 
                                    React.createElement("label", {for: "from"}, langClip.from), 
                                    React.createElement("input", {id: "from", type: "text", 
                                           onChange: function(e) {self.setState({from:e.target.value})}, 
                                           value: this.state.from, className: "form-control"}), 
                                    this.getError('from')
                                ), 
                                React.createElement("div", {className: "form-group"}, 
                                    React.createElement("label", {for: "subject"}, langClip.subject), 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    React.createElement("label", {for: "body"}, langClip.message), 
                                    React.createElement("textarea", {id: "body", type: "text", 
                                              onChange: function(e) {self.setState({body:e.target.value})}, 
                                              value: this.state.body, className: "form-control"}), 
                                    this.getError('body')
                                ), 
                                React.createElement("div", {className: "form-group url-wrap"}, 
...
var Pagination = React.createClass({displayName: "Pagination",
    ...
    pages: function () {
        ...
        if ((this.props.pageState.current_page - no_of_pages) > 0) {
            page.push(React.createElement("li", null, React.createElement("a", {style: {margin:'0px 20px'}, href: "#", onClick: this.clickHandler}, "langClip.firstPage")));
            page.push(React.createElement("li", null, React.createElement("a", {style: {margin:'0px 20px'}, href: "#", onClick: this.clickHandler}, "langClip.prev")));
        }

        if ((this.props.pageState.current_page - no_of_pages) > 0) {
            page.push(React.createElement("li", null, React.createElement("a", {href: "javascript:void();"}, "...")));
        }

        for (var i = no_of_pages - 1; i >= 0; i--) {
            if ((this.props.pageState.current_page - i) > 0) {
                page.push(React.createElement("li", null, React.createElement("a", {href: "#", onClick: this.clickHandler}, this.props.pageState.current_page - i)));
            }
        }

        page.push(React.createElement("li", {className: "active"}, React.createElement("a", {href: "javascript:void()"},  this.props.pageState.current_page + 1)));
        ...
        if ((this.props.pageState.total_pages - 1) != this.props.pageState.current_page) {
            page.push(React.createElement("li", {className: "num-text next"}, React.createElement("a", {href: "#", onClick: this.clickHandler}, langClip.nextpage)));
            page.push(React.createElement("li", {className: "num-text"}, React.createElement("a", {href: "#", onClick: this.clickHandler}, langClip.lastpage)));
        }
        ...
        return (
            React.createElement("tr", null, 
                React.createElement("td", null, 
                    React.createElement(Checkbox, {index: this.props.index, item: this.props.item, clipCollection: this.props.clipCollection, 
                ...
                React.createElement("td", null, 
                    React.createElement("span", {className: "country-name-title"}, langCountry[this.props.item.get('country_code')])
                ), 
                React.createElement("td", null, 
                    this.props.item.get('year')
                ), 
                React.createElement("td", null, 
                    React.createElement("ul", {dangerouslySetInnerHTML: {__html: this.getResource()}})
                ), 
                React.createElement("td", {className: "view-clip"}, 
                    React.createElement("span", {onClick: this.openViewPage})
                )
            )
        );
    }
...
var Checkbox = React.createClass({displayName: "Checkbox",
    ...
    render: function () {
        return (
            React.createElement("input", {type: "checkbox", name: this.getClassName(), className: this.getClassName(), 
    ...
    render: function () {
        ...
        if (this.state.clips) {
            tableview = this.state.clips.map(function (data, index) {
                return (React.createElement(Item, {item: data, key: index, index: index, clipCollection: self.props.clipCollection, 
        ...
        if (!this.state.loading) {
                    ...
                    React.createElement("table", {className: "table table-responsive table-contract table-contract-list"}, 
                        ...
                        React.createElement("tr", null, 
                            ...
                            React.createElement("th", {width: "35%"}, React.createElement("a", {
                                onClick: this.handleSort.bind(this,'text')}, langClip.text, this.showSortArrow('text'))), 
                            React.createElement("th", {width: "114px"}, React.createElement("a", {
                                onClick: this.handleSort.bind(this,'country')}, langClip.country, this.showSortArrow('country'))
                            ), 
            ...
            return (React.createElement("p", {className: "loading"}, langClip.loading));
        }
    }
});
var ClipView = React.createClass({displayName: "ClipView",
    render: function () {
        return (
            React.createElement("div", null, 
...
$(function () {
    ...
    React.render(React.createElement(ClipView, {clipCollection: clipCollection, clipLocal: clipData}),
