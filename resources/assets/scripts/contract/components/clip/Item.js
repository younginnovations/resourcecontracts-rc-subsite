...
export default class Item extends React.Component {
    ...
    render() {
        ...
        let clauseSummary = clauseSummaryNotPrepared
            ? annotationTerms.annotation_text_predefined_placeholder
        ...
        return (
            <tr>
                ...
                <td data-title={ annotationTerms.annotation_category }>
                    { this.props.category }
                </td>
                <td className="clipping-article" data-title={ annotationTerms.annotation_text }>
