...
return [
    ...
    'tagline'               => '<p class="repo-description">Un référentiel de </p> <div class="large-title olc-title"><span>Open Land Contracts</span></div>',
