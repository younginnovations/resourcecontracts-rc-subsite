				...
				<div class="col-lg-12">
					<div class="download-main-wrap">
						...
						<ul class="dropdown-menu">
							...
							@if(site()->canDownloadWordFile() && $contract->metadata->is_ocr_reviewed == 1 && $contract->pages->total > 0)
								<li>
									<a href="{{route('contract.download',['id'=> $contract->metadata->open_contracting_id])}}">@lang('annotation.word_file')</a>
								</li>
							@endif
						</ul>
					</div>
					<div class="pull-left social-share" id="social-toggler">
						...
						<ul class="social-toggle">
							<li class="facebook"><a href="https://www.facebook.com/sharer/sharer.php?u={{ url() }}"
													target="_blank">Facebook</a></li>
							<li class="google-plus"><a href="https://plus.google.com/share?url={{ url() }}"
													   target="_blank">Google</a></li>
							<li class="twitter"><a href="https://twitter.com/share?text={{ site()->meta('title')}}"
		...
		<div class="row annotation-list-wrapper" id="annotations">
			<div class="col-lg-12">
				<div class="panel panel-default panel-wrap panel-annotation-list-wrap">
					<div class="panel-heading"> {{count($contract->annotationsGroup)}} @if(count($contract->annotationsGroup) >1)
							Annotations @else Annotation @endif </div>
					<div class="panel-body">
								...
								@forelse($contract->annotationsCluster as $cluster => $annotations)
									...
									<div id="cluster-{{str_slug($cluster,'-')}}" class="cluster-wrap">
										...
										@foreach($annotations as $annotation)
											...
											<div>
												<div id="{{str_slug($annotation->category_key,'-')}}"
													 class="sub-category">
													<a href="#{{str_slug($annotation->category_key,'-')}}"><i
