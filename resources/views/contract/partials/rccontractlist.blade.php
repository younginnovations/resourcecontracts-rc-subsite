                    ...
                    <div class="download-main-wrap">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @if(env('CATEGORY')!= 'olc' && $contract->is_ocr_reviewed == true)
                                <li><a href="{{route('contract.download',['id'=> $contract->open_contracting_id])}}">@lang('global.ms_word')</a></li>
                            @endif
                            @if($annotations->total>0)
                                <li><a href="{{route('contract.annotations.download',['id'=> $contract->open_contracting_id])}}">@lang('global.ms_excel')<br><i>(@lang('global.annotation_only'))</i></a></li>
                            @endif
                        </ul>
                    </div>
                </div>
