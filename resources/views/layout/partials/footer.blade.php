<footer>
	<div class="footer-note">
		...
		@if(config('localisation') && url() !== \Illuminate\Support\Facades\Request::url() )
	...
	<div class="row">
		...
		<div class="col-lg-9 footer-right-wrap">
			<ul>
				@if(env("CATEGORY")=="rc")
					<li><a href="http://www.resourcegovernance.org/" target="_blank"><img
									src="{{url('images/ic-nrgi.png')}}" width="142" height="72"/></a></li>
				@endif
				<li><a href="http://ccsi.columbia.edu/" target="_blank"><img src="{{url('images/ic-cc.png')}}"
																			 width="194" height="49"/></a></li>
				<li><a href="http://www.worldbank.org/en/topic/governance" target="_blank"><img
								src="{{url('images/ic-worldbank.png')}}" width="218" height="43"/></a></li>
				<li><a href="http://www.dfid.gov.uk" target="_blank"><img src="{{url('images/ic-dfid.png')}}"
																		  width="147" height="50"/></a></li>
				@if(env("CATEGORY")=="rc")
					<li>
						<a href="http://www.afdb.org/en/topics-and-sectors/initiatives-partnerships/african-legal-support-facility/"
						   target="_blank"><img src="{{url('images/ic-alsf.png')}}" width="56" height="68"/></a></li>
				@endif
				<li><a href="http://data.industrie.gov.tn/" target="_blank"><img src="{{url('images/tunisienumerique.png')}}"/></a></li>
			</ul>
		</div>
		<div class="license-buttons">
			<p>@lang('footer.licensed') <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank">(CCBY-SA 4.0)</a></p>
