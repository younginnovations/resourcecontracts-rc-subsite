    ...
    <div class="row">
        ...
        <div class="col-lg-9 footer-right-wrap">
            <ul>
                ...
                @if(env("CATEGORY")=="rc")
                    <li><a href="http://www.afdb.org/en/topics-and-sectors/initiatives-partnerships/african-legal-support-facility/" target="_blank"><img src="{{url('images/ic-alsf.png')}}" width="56"
                                                                                                                                                          height="68"/></a></li>
                @endif
            </ul>
        </div>
        <div class="license-buttons">
            <p>@lang('footer.content_lisenced') <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank">(CC BY-SA 4.0)</a></p>
