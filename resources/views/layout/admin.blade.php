    ...
    <div class="row">
        <div class="col-sm-4 col-md-3">
            <div class="list-group">
                ...
                <a href="{{route('admin.link')}}" class="@if(strpos($url, 'link') != false) active @endif list-group-item">
                    <i class="fa fa-link"></i> @lang('admin.manage_link')
                </a>
                <a href="{{route('admin.text')}}" class="@if(strpos($url, 'text') != false) active @endif list-group-item">
                    <i class="fa fa-file-text-o"></i> @lang('admin.manage_text')
                </a>
                <a href="{{route('admin.partner')}}" class="@if(strpos($url, 'partner') != false) active @endif list-group-item">
